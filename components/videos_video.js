    ...
    items-top border border-slate-300">
        ...
        bg-center bg-[url('${this.data.thumb_url}')]">
          ...
          <div class="px-4 py-2 flex-col">
              ...
              <h2 class="title text-lg font-semibold leading-tight 
          ...
          <div class="absolute right-3 top-3 flex gap-1 items-center">
              ...
              text-bold" title="editar"><i class="fa fa-edit fa-fw fa-lg"></i></button>
              <button class="deletebutton bg-red-400 p-1 rounded-md text-white 
              text-bold" title="eliminar"><i class="fa fa-trash fa-fw fa-lg"></i></button>
          </div>
      </div>`;
  }
