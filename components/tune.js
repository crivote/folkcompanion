...
export class Tune extends Component {
    ...
    generatehtml_card() {
        ...
        ${this.data.tuneref.ABCsample ? 
            `<span class="text-white/30 m-auto drop-shadow-xl"><i data-abc="${this.data.tuneref.ABCsample}" data-state="stop" class="playabc m-auto fa fa-circle-play fa-5x"></i><span>` : '' }
        </div>
