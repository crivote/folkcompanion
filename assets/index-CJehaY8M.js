...
`);if(ce.synth.supportsAudio()){const t=ce.renderAbc("*",e)[0];q.midiBuffer=new ce.synth.CreateSynth,q.midiBuffer.init({visualObj:t,options:{}}).then(function(){q.midiBuffer.prime().then(function(){q.midiBuffer.start()})}).catch(function(a){console.warn("Audio problem:",a)})}else console.warn("Audio not supported")}static stopabc(){q.midiBuffer&&q.midiBuffer.stop()}static manageabc(s){s.stopPropagation();const e=s.currentTarget;e instanceof HTMLElement&&(e.dataset.state=="playing"?(e.dataset.state="stop",q.stopabc(),e.querySelector("i").classList.remove("fa-circle-stop"),e.querySelector("i").classList.add("fa-play-circle")):(e.dataset.state="playing",q.playabc(e.dataset.abc),e.querySelector("i").classList.remove("fa-play-circle"),e.querySelector("i").classList.add("fa-circle-stop")))}};o(q,"midiBuffer");let P=q,p=class G{static generatelinks(s){const e=[];return s&&s.forEach(t=>{let a;switch(t==null?void 0:t.service_name){case"thesession.org":a="https://thesession.org/tunes/"+t.service_ID,e.push(`<a class="bg-yellow-600 px-2 rounded-full text-sm" 
    ...
    <section id="${this.name}">
      ...
      <div class="user ml-auto mr-6">
        ...
        </div>`}eliminate(){this.element.classList.remove("animate__fadeInUp"),this.element.classList.add("animate__backOutRight"),this.element.addEventListener("animationend",()=>{this.remove()})}}class Ue extends S{constructor(e,t,a,r="new"){super(e,t);o(this,"tune");o(this,"pics");o(this,"isNew");this.isNew=r=="new";const i=this.isNew?"tunes":"tunebook";this.tune=l[i].find(c=>c.id===a),this.setup()}async setup(){this.pics=await V.search(this.isNew?this.tune.other_names[0]:this.tune.prefered_name),this.pics=this.pics.concat(l.genericpics),this.isNew||this.pics.unshift(this.tune.preferred_img_url),this.attachAt(this.generatehtml(),!1),this.addListeners()}generatehtml(){const e=this.isNew?this.tune:this.tune.tuneref;e.tunekeys=e.Modes_played.map(i=>`${i.Key} ${i.Mode}`);const t=this.isNew?l.status[0].label:p.getstatus(this.tune.status_num).label,a=this.isNew||this.tune.tags.length==0?"":this.tune.tags.join(" "),r=this.isNew||this.tune.notes.trim()==""?"":this.tune.notes;return`
  ...
  ${Utils.generateformfield("type","Categoría de vídeo",this.isNew?"":this.video.type,l.videotypes)}
    ...
    <div>
  </div>`}}let Et=class extends S{constructor(s,e,t){super(s,e),this.id=t,this.data=l.setbook.find(a=>a.id===this.id),this.setup()}setup(){this.attachAt(this.generatehtml(),!1),this.addListeners()}generatehtml(){let s="";return this.data.tunes.forEach(e=>{const t=l.tunebook.find(a=>a.id===e.tunebook_id);t&&(s+=`
  ...
  ${p.generateformfield("type","Categoría de vídeo",this.isNew?"":this.video.type,l.videotypes)}
    ...
    my-3 rounded-md p-4 hover:bg-slate-300 transition cursor-pointer">
      ...
      <main class="p-6"></main>
      </section>`}sortTunes(e){return e.sort((a,r)=>r.points!==a.points?r.points-a.points:new Date(r.last_rehearsalDate)-new Date(a.last_rehearsalDate))}sorter(e){const t=e.target.value;this.sortcriteria=t,this.tunelist.sort((a,r)=>{const i=this.sortcriteria=="type"?a.tuneref.type:a[this.sortcriteria],c=this.sortcriteria=="type"?r.tuneref.type:r[this.sortcriteria];return i<c?this.sortorder=="ASC"?-1:1:i>c?this.sortorder=="ASC"?1:-1:0}),this.renderList()}createList(){const e=this.assignPointsTunes();this.tunelist=e.slice(0,this.numberTunes),this.renderList()}renderList(){this.contentZone.innerHTML="",this.tuneinstances=this.tunelist.map(e=>new Mt("tune"+e.id,this.contentZone,e,this.maxRehear))}}const _e=Object.freeze(Object.defineProperty({__proto__:null,Game:qt,Learn:Ot,Login:bt,Menubar:$t,Mynotification:b,Rehear:Dt,Setbook:Tt,Stats:It,Tunebook:_t,Tunemanager:ze,Videos:Pt},Symbol.toStringTag,{value:"Module"}));function Rt(n){return n&&n.__esModule&&Object.prototype.hasOwnProperty.call(n,"default")?n.default:n}var Ae=Object.prototype.toString,Ge=function(s){var e=Ae.call(s),t=e==="[object Arguments]";return t||(t=e!=="[object Array]"&&s!==null&&typeof s=="object"&&typeof s.length=="number"&&s.length>=0&&Ae.call(s.callee)==="[object Function]"),t},de,Ee;function Ct(){if(Ee)return de;Ee=1;var n;if(!Object.keys){var s=Object.prototype.hasOwnProperty,e=Object.prototype.toString,t=Ge,a=Object.prototype.propertyIsEnumerable,r=!a.call({toString:null},"toString"),i=a.call(function(){},"prototype"),c=["toString","toLocaleString","valueOf","hasOwnProperty","isPrototypeOf","propertyIsEnumerable","constructor"],d=function(y){var f=y.constructor;return f&&f.prototype===y},g={$applicationCache:!0,$console:!0,$external:!0,$frame:!0,$frameElement:!0,$frames:!0,$innerHeight:!0,$innerWidth:!0,$onmozfullscreenchange:!0,$onmozfullscreenerror:!0,$outerHeight:!0,$outerWidth:!0,$pageXOffset:!0,$pageYOffset:!0,$parent:!0,$scrollLeft:!0,$scrollTop:!0,$scrollX:!0,$scrollY:!0,$self:!0,$webkitIndexedDB:!0,$webkitStorageInfo:!0,$window:!0},$=function(){if(typeof window>"u")return!1;for(var y in window)try{if(!g["$"+y]&&s.call(window,y)&&window[y]!==null&&typeof window[y]=="object")try{d(window[y])}catch{return!0}}catch{return!0}return!1}(),_=function(y){if(typeof window>"u"||!$)return d(y);try{return d(y)}catch{return!1}};n=function(f){var E=f!==null&&typeof f=="object",T=e.call(f)==="[object Function]",I=t(f),j=E&&e.call(f)==="[object String]",U=[];if(!E&&!T&&!I)throw new TypeError("Object.keys called on a non-object");var mt=i&&T;if(j&&f.length>0&&!s.call(f,0))for(var ie=0;ie<f.length;++ie)U.push(String(ie));if(I&&f.length>0)for(var oe=0;oe<f.length;++oe)U.push(String(oe));else for(var le in f)!(mt&&le==="prototype")&&s.call(f,le)&&U.push(String(le));if(r)for(var ft=_(f),H=0;H<c.length;++H)!(ft&&c[H]==="constructor")&&s.call(f,c[H])&&U.push(c[H]);return U}}return de=n,de}var Bt=Array.prototype.slice,Ft=Ge,Te=Object.keys,X=Te?function(s){return Te(s)}:Ct(),qe=Object.keys;X.shim=function(){if(Object.keys){var s=function(){var e=Object.keys(arguments);return e&&e.length===arguments.length}(1,2);s||(Object.keys=function(t){return Ft(t)?qe(Bt.call(t)):qe(t)})}else Object.keys=X;return Object.keys||X};var Nt=X,zt=Error,Ut=EvalError,Ht=RangeError,Gt=ReferenceError,Ve=SyntaxError,W=TypeError,Vt=URIError,Kt=function(){if(typeof Symbol!="function"||typeof Object.getOwnPropertySymbols!="function")return!1;if(typeof Symbol.iterator=="symbol")return!0;var s={},e=Symbol("test"),t=Object(e);if(typeof e=="string"||Object.prototype.toString.call(e)!=="[object Symbol]"||Object.prototype.toString.call(t)!=="[object Symbol]")return!1;var a=42;s[e]=a;for(e in s)return!1;if(typeof Object.keys=="function"&&Object.keys(s).length!==0||typeof Object.getOwnPropertyNames=="function"&&Object.getOwnPropertyNames(s).length!==0)return!1;var r=Object.getOwnPropertySymbols(s);if(r.length!==1||r[0]!==e||!Object.prototype.propertyIsEnumerable.call(s,e))return!1;if(typeof Object.getOwnPropertyDescriptor=="function"){var i=Object.getOwnPropertyDescriptor(s,e);if(i.value!==a||i.enumerable!==!0)return!1}return!0},je=typeof Symbol<"u"&&Symbol,Wt=Kt,Zt=function(){return typeof je!="function"||typeof Symbol!="function"||typeof je("foo")!="symbol"||typeof Symbol("bar")!="symbol"?!1:Wt()},ue={__proto__:null,foo:{}},Jt=Object,Yt=function(){return{__proto__:ue}.foo===ue.foo&&!(ue instanceof Jt)},Qt="Function.prototype.bind called on incompatible ",Xt=Object.prototype.toString,es=Math.max,ts="[object Function]",Pe=function(s,e){for(var t=[],a=0;a<s.length;a+=1)t[a]=s[a];for(var r=0;r<e.length;r+=1)t[r+s.length]=e[r];return t},ss=function(s,e){for(var t=[],a=e,r=0;a<s.length;a+=1,r+=1)t[r]=s[a];return t},as=function(n,s){for(var e="",t=0;t<n.length;t+=1)e+=n[t],t+1<n.length&&(e+=s);return e},rs=function(s){var e=this;if(typeof e!="function"||Xt.apply(e)!==ts)throw new TypeError(Qt+e);for(var t=ss(arguments,1),a,r=function(){if(this instanceof a){var $=e.apply(this,Pe(t,arguments));return Object($)===$?$:this}return e.apply(s,Pe(t,arguments))},i=es(0,e.length-t.length),c=[],d=0;d<i;d++)c[d]="$"+d;if(a=Function("binder","return function ("+as(c,",")+"){ return binder.apply(this,arguments); }")(r),e.prototype){var g=function(){};g.prototype=e.prototype,a.prototype=new g,g.prototype=null}return a},ns=rs,ye=Function.prototype.bind||ns,is=Function.prototype.call,os=Object.prototype.hasOwnProperty,ls=ye,Ke=ls.call(is,os),m,cs=zt,ds=Ut,us=Ht,hs=Gt,z=Ve,N=W,ps=Vt,We=Function,he=function(n){try{return We('"use strict"; return ('+n+").constructor;")()}catch{}},O=Object.getOwnPropertyDescriptor;if(O)try{O({},"")}catch{O=null}var pe=function(){throw new N},ms=O?function(){try{return arguments.callee,pe}catch{try{return O(arguments,"callee").get}catch{return pe}}}():pe,C=Zt(),fs=Yt(),A=Object.getPrototypeOf||(fs?function(n){return n.__proto__}:null),F={},gs=typeof Uint8Array>"u"||!A?m:A(Uint8Array),R={__proto__:null,"%AggregateError%":typeof AggregateError>"u"?m:AggregateError,"%Array%":Array,"%ArrayBuffer%":typeof ArrayBuffer>"u"?m:ArrayBuffer,"%ArrayIteratorPrototype%":C&&A?A([][Symbol.iterator]()):m,"%AsyncFromSyncIteratorPrototype%":m,"%AsyncFunction%":F,"%AsyncGenerator%":F,"%AsyncGeneratorFunction%":F,"%AsyncIteratorPrototype%":F,"%Atomics%":typeof Atomics>"u"?m:Atomics,"%BigInt%":typeof BigInt>"u"?m:BigInt,"%BigInt64Array%":typeof BigInt64Array>"u"?m:BigInt64Array,"%BigUint64Array%":typeof BigUint64Array>"u"?m:BigUint64Array,"%Boolean%":Boolean,"%DataView%":typeof DataView>"u"?m:DataView,"%Date%":Date,"%decodeURI%":decodeURI,"%decodeURIComponent%":decodeURIComponent,"%encodeURI%":encodeURI,"%encodeURIComponent%":encodeURIComponent,"%Error%":cs,"%eval%":eval,"%EvalError%":ds,"%Float32Array%":typeof Float32Array>"u"?m:Float32Array,"%Float64Array%":typeof Float64Array>"u"?m:Float64Array,"%FinalizationRegistry%":typeof FinalizationRegistry>"u"?m:FinalizationRegistry,"%Function%":We,"%GeneratorFunction%":F,"%Int8Array%":typeof Int8Array>"u"?m:Int8Array,"%Int16Array%":typeof Int16Array>"u"?m:Int16Array,"%Int32Array%":typeof Int32Array>"u"?m:Int32Array,"%isFinite%":isFinite,"%isNaN%":isNaN,"%IteratorPrototype%":C&&A?A(A([][Symbol.iterator]())):m,"%JSON%":typeof JSON=="object"?JSON:m,"%Map%":typeof Map>"u"?m:Map,"%MapIteratorPrototype%":typeof Map>"u"||!C||!A?m:A(new Map()[Symbol.iterator]()),"%Math%":Math,"%Number%":Number,"%Object%":Object,"%parseFloat%":parseFloat,"%parseInt%":parseInt,"%Promise%":typeof Promise>"u"?m:Promise,"%Proxy%":typeof Proxy>"u"?m:Proxy,"%RangeError%":us,"%ReferenceError%":hs,"%Reflect%":typeof Reflect>"u"?m:Reflect,"%RegExp%":RegExp,"%Set%":typeof Set>"u"?m:Set,"%SetIteratorPrototype%":typeof Set>"u"||!C||!A?m:A(new Set()[Symbol.iterator]()),"%SharedArrayBuffer%":typeof SharedArrayBuffer>"u"?m:SharedArrayBuffer,"%String%":String,"%StringIteratorPrototype%":C&&A?A(""[Symbol.iterator]()):m,"%Symbol%":C?Symbol:m,"%SyntaxError%":z,"%ThrowTypeError%":ms,"%TypedArray%":gs,"%TypeError%":N,"%Uint8Array%":typeof Uint8Array>"u"?m:Uint8Array,"%Uint8ClampedArray%":typeof Uint8ClampedArray>"u"?m:Uint8ClampedArray,"%Uint16Array%":typeof Uint16Array>"u"?m:Uint16Array,"%Uint32Array%":typeof Uint32Array>"u"?m:Uint32Array,"%URIError%":ps,"%WeakMap%":typeof WeakMap>"u"?m:WeakMap,"%WeakRef%":typeof WeakRef>"u"?m:WeakRef,"%WeakSet%":typeof WeakSet>"u"?m:WeakSet};if(A)try{null.error}catch(n){var ys=A(A(n));R["%Error.prototype%"]=ys}var bs=function n(s){var e;if(s==="%AsyncFunction%")e=he("async function () {}");else if(s==="%GeneratorFunction%")e=he("function* () {}");else if(s==="%AsyncGeneratorFunction%")e=he("async function* () {}");else if(s==="%AsyncGenerator%"){var t=n("%AsyncGeneratorFunction%");t&&(e=t.prototype)}else if(s==="%AsyncIteratorPrototype%"){var a=n("%AsyncGenerator%");a&&A&&(e=A(a.prototype))}return R[s]=e,e},Ie={__proto__:null,"%ArrayBufferPrototype%":["ArrayBuffer","prototype"],"%ArrayPrototype%":["Array","prototype"],"%ArrayProto_entries%":["Array","prototype","entries"],"%ArrayProto_forEach%":["Array","prototype","forEach"],"%ArrayProto_keys%":["Array","prototype","keys"],"%ArrayProto_values%":["Array","prototype","values"],"%AsyncFunctionPrototype%":["AsyncFunction","prototype"],"%AsyncGenerator%":["AsyncGeneratorFunction","prototype"],"%AsyncGeneratorPrototype%":["AsyncGeneratorFunction","prototype","prototype"],"%BooleanPrototype%":["Boolean","prototype"],"%DataViewPrototype%":["DataView","prototype"],"%DatePrototype%":["Date","prototype"],"%ErrorPrototype%":["Error","prototype"],"%EvalErrorPrototype%":["EvalError","prototype"],"%Float32ArrayPrototype%":["Float32Array","prototype"],"%Float64ArrayPrototype%":["Float64Array","prototype"],"%FunctionPrototype%":["Function","prototype"],"%Generator%":["GeneratorFunction","prototype"],"%GeneratorPrototype%":["GeneratorFunction","prototype","prototype"],"%Int8ArrayPrototype%":["Int8Array","prototype"],"%Int16ArrayPrototype%":["Int16Array","prototype"],"%Int32ArrayPrototype%":["Int32Array","prototype"],"%JSONParse%":["JSON","parse"],"%JSONStringify%":["JSON","stringify"],"%MapPrototype%":["Map","prototype"],"%NumberPrototype%":["Number","prototype"],"%ObjectPrototype%":["Object","prototype"],"%ObjProto_toString%":["Object","prototype","toString"],"%ObjProto_valueOf%":["Object","prototype","valueOf"],"%PromisePrototype%":["Promise","prototype"],"%PromiseProto_then%":["Promise","prototype","then"],"%Promise_all%":["Promise","all"],"%Promise_reject%":["Promise","reject"],"%Promise_resolve%":["Promise","resolve"],"%RangeErrorPrototype%":["RangeError","prototype"],"%ReferenceErrorPrototype%":["ReferenceError","prototype"],"%RegExpPrototype%":["RegExp","prototype"],"%SetPrototype%":["Set","prototype"],"%SharedArrayBufferPrototype%":["SharedArrayBuffer","prototype"],"%StringPrototype%":["String","prototype"],"%SymbolPrototype%":["Symbol","prototype"],"%SyntaxErrorPrototype%":["SyntaxError","prototype"],"%TypedArrayPrototype%":["TypedArray","prototype"],"%TypeErrorPrototype%":["TypeError","prototype"],"%Uint8ArrayPrototype%":["Uint8Array","prototype"],"%Uint8ClampedArrayPrototype%":["Uint8ClampedArray","prototype"],"%Uint16ArrayPrototype%":["Uint16Array","prototype"],"%Uint32ArrayPrototype%":["Uint32Array","prototype"],"%URIErrorPrototype%":["URIError","prototype"],"%WeakMapPrototype%":["WeakMap","prototype"],"%WeakSetPrototype%":["WeakSet","prototype"]},Z=ye,ae=Ke,vs=Z.call(Function.call,Array.prototype.concat),xs=Z.call(Function.apply,Array.prototype.splice),De=Z.call(Function.call,String.prototype.replace),re=Z.call(Function.call,String.prototype.slice),ws=Z.call(Function.call,RegExp.prototype.exec),$s=/[^%.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(?:\.|\[\])(?:\.|\[\]|%$))/g,Ss=/\\(\\)?/g,ks=function(s){var e=re(s,0,1),t=re(s,-1);if(e==="%"&&t!=="%")throw new z("invalid intrinsic syntax, expected closing `%`");if(t==="%"&&e!=="%")throw new z("invalid intrinsic syntax, expected opening `%`");var a=[];return De(s,$s,function(r,i,c,d){a[a.length]=c?De(d,Ss,"$1"):i||r}),a},Ls=function(s,e){var t=s,a;if(ae(Ie,t)&&(a=Ie[t],t="%"+a[0]+"%"),ae(R,t)){var r=R[t];if(r===F&&(r=bs(t)),typeof r>"u"&&!e)throw new N("intrinsic "+s+" exists, but is not available. Please file an issue!");return{alias:a,name:t,value:r}}throw new z("intrinsic "+s+" does not exist!")},J=function(s,e){if(typeof s!="string"||s.length===0)throw new N("intrinsic name must be a non-empty string");if(arguments.length>1&&typeof e!="boolean")throw new N('"allowMissing" argument must be a boolean');if(ws(/^%?[^%]*%?$/,s)===null)throw new z("`%` may not be present anywhere but at the beginning and end of the intrinsic name");var t=ks(s),a=t.length>0?t[0]:"",r=Ls("%"+a+"%",e),i=r.name,c=r.value,d=!1,g=r.alias;g&&(a=g[0],xs(t,vs([0,1],g)));for(var $=1,_=!0;$<t.length;$+=1){var y=t[$],f=re(y,0,1),E=re(y,-1);if((f==='"'||f==="'"||f==="`"||E==='"'||E==="'"||E==="`")&&f!==E)throw new z("property names with quotes must have matching quotes");if((y==="constructor"||!_)&&(d=!0),a+="."+y,i="%"+a+"%",ae(R,i))c=R[i];else if(c!=null){if(!(y in c)){if(!e)throw new N("base intrinsic for "+s+" exists, but the property is not available.");return}if(O&&$+1>=t.length){var T=O(c,y);_=!!T,_&&"get"in T&&!("originalValue"in T.get)?c=T.get:c=c[y]}else _=ae(c,y),c=c[y];_&&!d&&(R[i]=c)}}return c},_s=J,ee=_s("%Object.defineProperty%",!0)||!1;if(ee)try{ee({},"a",{value:1})}catch{ee=!1}var be=ee,As=J,te=As("%Object.getOwnPropertyDescriptor%",!0);if(te)try{te([],"length")}catch{te=null}var Ze=te,Me=be,Es=Ve,B=W,Oe=Ze,Je=function(s,e,t){if(!s||typeof s!="object"&&typeof s!="function")throw new B("`obj` must be an object or a function`");if(typeof e!="string"&&typeof e!="symbol")throw new B("`property` must be a string or a symbol`");if(arguments.length>3&&typeof arguments[3]!="boolean"&&arguments[3]!==null)throw new B("`nonEnumerable`, if provided, must be a boolean or null");if(arguments.length>4&&typeof arguments[4]!="boolean"&&arguments[4]!==null)throw new B("`nonWritable`, if provided, must be a boolean or null");if(arguments.length>5&&typeof arguments[5]!="boolean"&&arguments[5]!==null)throw new B("`nonConfigurable`, if provided, must be a boolean or null");if(arguments.length>6&&typeof arguments[6]!="boolean")throw new B("`loose`, if provided, must be a boolean");var a=arguments.length>3?arguments[3]:null,r=arguments.length>4?arguments[4]:null,i=arguments.length>5?arguments[5]:null,c=arguments.length>6?arguments[6]:!1,d=!!Oe&&Oe(s,e);if(Me)Me(s,e,{configurable:i===null&&d?d.configurable:!i,enumerable:a===null&&d?d.enumerable:!a,value:t,writable:r===null&&d?d.writable:!r});else if(c||!a&&!r&&!i)s[e]=t;else throw new Es("This environment does not support defining a property as non-configurable, non-writable, or non-enumerable.")},fe=be,Ye=function(){return!!fe};Ye.hasArrayLengthDefineBug=function(){if(!fe)return null;try{return fe([],"length",{value:1}).length!==1}catch{return!0}};var Qe=Ye,Ts=Nt,qs=typeof Symbol=="function"&&typeof Symbol("foo")=="symbol",js=Object.prototype.toString,Ps=Array.prototype.concat,Re=Je,Is=function(n){return typeof n=="function"&&js.call(n)==="[object Function]"},Xe=Qe(),Ds=function(n,s,e,t){if(s in n){if(t===!0){if(n[s]===e)return}else if(!Is(t)||!t())return}Xe?Re(n,s,e,!0):Re(n,s,e)},et=function(n,s){var e=arguments.length>2?arguments[2]:{},t=Ts(s);qs&&(t=Ps.call(t,Object.getOwnPropertySymbols(s)));for(var a=0;a<t.length;a+=1)Ds(n,t[a],s[t[a]],e[t[a]])};et.supportsDescriptors=!!Xe;var tt=et,st={exports:{}},Ms=J,Ce=Je,Os=Qe(),Be=Ze,Fe=W,Rs=Ms("%Math.floor%"),Cs=function(s,e){if(typeof s!="function")throw new Fe("`fn` is not a function");if(typeof e!="number"||e<0||e>4294967295||Rs(e)!==e)throw new Fe("`length` must be a positive 32-bit integer");var t=arguments.length>2&&!!arguments[2],a=!0,r=!0;if("length"in s&&Be){var i=Be(s,"length");i&&!i.configurable&&(a=!1),i&&!i.writable&&(r=!1)}return(a||r||!t)&&(Os?Ce(s,"length",e,!0,!0):Ce(s,"length",e)),s};(function(n){var s=ye,e=J,t=Cs,a=W,r=e("%Function.prototype.apply%"),i=e("%Function.prototype.call%"),c=e("%Reflect.apply%",!0)||s.call(i,r),d=be,g=e("%Math.max%");n.exports=function(y){if(typeof y!="function")throw new a("a function is required");var f=c(s,i,arguments);return t(f,1+g(0,y.length-(arguments.length-1)),!0)};var $=function(){return c(s,r,arguments)};d?d(n.exports,"apply",{value:$}):n.exports.apply=$})(st);var at=st.exports,Bs=W,Fs=function(s){if(s==null)throw new Bs(arguments.length>0&&arguments[1]||"Cannot call method on "+s);return s},rt=J,nt=at,Ns=nt(rt("String.prototype.indexOf")),zs=function(s,e){var t=rt(s,!!e);return typeof t=="function"&&Ns(s,".prototype.")>-1?nt(t):t},Us=Fs,it=zs,Hs=it("Object.prototype.propertyIsEnumerable"),Gs=it("Array.prototype.push"),ot=function(s){var e=Us(s),t=[];for(var a in e)Hs(e,a)&&Gs(t,[a,e[a]]);return t},Vs=ot,lt=function(){return typeof Object.entries=="function"?Object.entries:Vs},Ks=lt,Ws=tt,Zs=function(){var s=Ks();return Ws(Object,{entries:s},{entries:function(){return Object.entries!==s}}),s},Js=tt,Ys=at,Qs=ot,ct=lt,Xs=Zs,dt=Ys(ct(),Object);Js(dt,{getPolyfill:ct,implementation:Qs,shim:Xs});var ea=dt,ve=ea,ut=Ke,ta=function(s){},ge=String.prototype.replace,ht=String.prototype.split,se="||||",Q=function(n){var s=n%100,e=s%10;return s!==11&&e===1?0:2<=e&&e<=4&&!(s>=12&&s<=14)?1:2},pt={pluralTypes:{arabic:function(n){if(n<3)return n;var s=n%100;return s>=3&&s<=10?3:s>=11?4:5},bosnian_serbian:Q,chinese:function(){return 0},croatian:Q,french:function(n){return n>=2?1:0},german:function(n){return n!==1?1:0},russian:Q,lithuanian:function(n){return n%10===1&&n%100!==11?0:n%10>=2&&n%10<=9&&(n%100<11||n%100>19)?1:2},czech:function(n){return n===1?0:n>=2&&n<=4?1:2},polish:function(n){if(n===1)return 0;var s=n%10;return 2<=s&&s<=4&&(n%100<10||n%100>=20)?1:2},icelandic:function(n){return n%10!==1||n%100===11?1:0},slovenian:function(n){var s=n%100;return s===1?0:s===2?1:s===3||s===4?2:3},romanian:function(n){if(n===1)return 0;var s=n%100;return n===0||s>=2&&s<=19?1:2},ukrainian:Q},pluralTypeToLanguages:{arabic:["ar"],bosnian_serbian:["bs-Latn-BA","bs-Cyrl-BA","srl-RS","sr-RS"],chinese:["id","id-ID","ja","ko","ko-KR","lo","ms","th","th-TH","zh"],croatian:["hr","hr-HR"],german:["fa","da","de","en","es","fi","el","he","hi-IN","hu","hu-HU","it","nl","no","pt","sv","tr"],french:["fr","tl","pt-br"],russian:["ru","ru-RU"],lithuanian:["lt"],czech:["cs","cs-CZ","sk"],polish:["pl"],icelandic:["is","mk"],slovenian:["sl-SL"],romanian:["ro"],ukrainian:["uk","ua"]}};function sa(n){for(var s={},e=ve(n),t=0;t<e.length;t+=1)for(var a=e[t][0],r=e[t][1],i=0;i<r.length;i+=1)s[r[i]]=a;return s}function aa(n,s){var e=sa(n.pluralTypeToLanguages);return e[s]||e[ht.call(s,/-/,1)[0]]||e.en}function ra(n,s,e){return n.pluralTypes[s](e)}function na(){var n={};return function(s,e){var t=n[e];return t&&!s.pluralTypes[t]&&(t=null,n[e]=t),t||(t=aa(s,e),t&&(n[e]=t)),t}}function Ne(n){return n.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")}function ia(n){var s=n&&n.prefix||"%{",e=n&&n.suffix||"}";if(s===se||e===se)throw new RangeError('"'+se+'" token is reserved for pluralization');return new RegExp(Ne(s)+"(.*?)"+Ne(e),"g")}var oa=na(),la=/%\{(.*?)\}/g;function xe(n,s,e,t,a,r){if(typeof n!="string")throw new TypeError("Polyglot.transformPhrase expects argument #1 to be string");if(s==null)return n;var i=n,c=t||la,d=r||ge,g=typeof s=="number"?{smart_count:s}:s;if(g.smart_count!=null&&n){var $=a||pt,_=ht.call(n,se),y=e||"en",f=oa($,y),E=ra($,f,g.smart_count);i=ge.call(_[E]||_[0],/^[^\S]*|[^\S]*$/g,"")}return i=d.call(i,c,function(T,I){return!ut(g,I)||g[I]==null?T:g[I]}),i}function D(n){var s=n||{};this.phrases={},this.extend(s.phrases||{}),this.currentLocale=s.locale||"en";var e=s.allowMissing?xe:null;this.onMissingKey=typeof s.onMissingKey=="function"?s.onMissingKey:e,this.warn=s.warn||ta,this.replaceImplementation=s.replace||ge,this.tokenRegex=ia(s.interpolation),this.pluralRules=s.pluralRules||pt}D.prototype.locale=function(n){return n&&(this.currentLocale=n),this.currentLocale};D.prototype.extend=function(n,s){for(var e=ve(n||{}),t=0;t<e.length;t+=1){var a=e[t][0],r=e[t][1],i=s?s+"."+a:a;typeof r=="object"?this.extend(r,i):this.phrases[i]=r}};D.prototype.unset=function(n,s){if(typeof n=="string")delete this.phrases[n];else for(var e=ve(n||{}),t=0;t<e.length;t+=1){var a=e[t][0],r=e[t][1],i=s?s+"."+a:a;typeof r=="object"?this.unset(r,i):delete this.phrases[i]}};D.prototype.clear=function(){this.phrases={}};D.prototype.replace=function(n){this.clear(),this.extend(n)};D.prototype.t=function(n,s){var e,t,a=s??{};if(typeof this.phrases[n]=="string")e=this.phrases[n];else if(typeof a._=="string")e=a._;else if(this.onMissingKey){var r=this.onMissingKey;t=r(n,a,this.currentLocale,this.tokenRegex,this.pluralRules,this.replaceImplementation)}else this.warn('Missing translation for key: "'+n+'"'),t=n;return typeof e=="string"&&(t=xe(e,a,this.currentLocale,this.tokenRegex,this.pluralRules,this.replaceImplementation)),t};D.prototype.has=function(n){return ut(this.phrases,n)};D.transformPhrase=function(s,e,t){return xe(s,e,t)};var ca=D;const da=Rt(ca),ua={token:{token_ok:"Valid token, user data retrieved.",token_ko:"The saved token is not valid."},login:{title:"Log In",email:"Email",pass:"Password",login:"Login",new_user:"Do you want to create a new account?",required_mail:"Email is required",required_pass:"Enter password",login_error:"Login error"},menubar:{manager:"tune manager",videos:"videos",suggest:"requests",tunebook:"repertoire",sets:"sets",learn:"learn",practice:"practice",game:"game",stats:"stats",signoff:"sign off"},tunebook:{sorttitle:"name",sortstatus:"status",sortlast:"last practice",sortkey:"key",sortnumber:"practice count",title:"My Repertoire",tunes:"tunes",search:"text search",show:"showing",filtered:"filtered tunes",alltypes:"all types",allkeys:"all keys",allstatus:"all statuses"}},ha={token:{token_ok:"token válido, datos de usuario recuperados.",token_ko:"el token guardado no es válido."},login:{title:"Inicio de Sesión",email:"Correo Electrónico",pass:"Contraseña",login:"Iniciar Sesión",new_user:"¿Desea crear una cuenta nueva?",required_mail:"Email obligatorio",required_pass:"Introduce contraseña",login_error:"Error en login"},menubar:{manager:"temas",videos:"videos",suggest:"peticiones",tunebook:"repertorio",sets:"sets",learn:"aprender",practice:"ensayar",game:"juego",stats:"historial",signoff:"cerrar sesión"},tunebook:{sorttitle:"nombre",sortstatus:"status",sortlast:"último ensayo",sortkey:"tonalidad",sortnumber:"nº de ensayos",title:"Mi repertorio",tunes:"temas",search:"busqueda por texto",show:"mostrando",filtered:"temas filtrados",alltypes:"todos los tipos",allkeys:"todos los tonos",allstatus:"todos los status"}},k=class k{static getinstance(s){if(Object.hasOwn(_e,s)){const e=s==="Menubar"?k.menuelement:k.htmlelement,t=new _e[s](s,e);return s!=="Menubar"&&(k.activeScreen=t),t}}static async getuserdetails(){k.poly=new da({phrases:ua});const s=localStorage.getItem("token");if(s)try{const e=await L.getuser(s);l.user=e,l.user.lang!=="en"&&k.poly.replace(ha),new b("success",k.poly.t("token.token_ok")),k.startapp()}catch{new b("warning",k.poly.t("token.token_ko")),localStorage.removeItem("token"),k.getinstance("Login")}else k.getinstance("Login")}static async startapp(){await k.loadAlltunes(),await k.loadGenericPics(),await k.loadUserTunebook(),await k.loadUserSetbook(),k.getinstance("Menubar")}static async loadGenericPics(){if(l.genericpics=await V.initialize(),l.genericpics&&l.genericpics.length>0)return new b("success",`cargadas ${l.genericpics.length} imagenes genéricas.`),!0;new b("danger","error al cargar fotos genericas.")}static async loadAlltunes(){if(l.tunes=await L.getalltunes(),l.tunes&&l.tunes.length>0)return l.tunes.forEach(s=>{s!=null&&s.other_names?s.other_names.includes(s.main_name)||s.other_names.push(s.main_name):s.other_names=[s.main_name],(!s.sortname||s.sortname.length==0)&&(s.sortname=p.titleforsort(s.main_name))}),new b("success",`cargados ${l.tunes.length} temas.`),!0;new b("danger","error al cargar todos los temas.")}static async loadUserTunebook(){return l.tunebook=await L.gettunebook(),l.tunebook&&l.tunebook.length>0?(l.tunebook.forEach(s=>{s.tuneref=l.tunes.find(e=>e.id===s.tunes_id),p.calcValueforTunes(s)}),new b("success",`cargados ${l.tunebook.length} temas de tu repertorio.`),!0):(new b("info","no tienes nada en tu repertorio."),!0)}static async loadUserSetbook(){if(l.setbook=await L.getsetbook(),l.setbook&&l.setbook.length>0)return new b("success",`cargados ${l.setbook.length} sets de tu repertorio.`),!0;new b("info","no tienes ningun set.")}static async addrehearsal(s){let e=l.tunebook.find(i=>i.id==s);const t=JSON.parse(JSON.stringify(e));Array.isArray(e.last_rehearsals)||(e.last_rehearsals=[]);const a=new Date;return e.last_rehearsalDate=a.valueOf(),e.last_rehearsals.unshift(e.last_rehearsalDate),e.last_rehearsals.length>10&&(e.last_rehearsals=e.last_rehearsals.slice(0,10)),e.rehearsal_days++,await L.edittunebooktune(s,e)?(p.calcValueforTunes(e),new b("success",`añadido nuevo ensayo de ${e.prefered_name}.`),!0):(e=t,new b("danger","error al guardar el ensayo."),!1)}static async changeStatus(s,e){const t=l.tunebook.find(i=>i.id==s);t.status_num=e;const a=await L.edittunebooktune(s,t),r=p.getstatus(e);return a?(new b("success",`cambiado status de ${t.prefered_name} a ${r.label}`),!0):(new b("danger","error al cambiar status."),!1)}};o(k,"htmlelement",document.getElementById("app")),o(k,"menuelement",document.getElementById("menuholder")),o(k,"activeScreen"),o(k,"midiBuffer"),o(k,"player"),o(k,"searchtunes",[]),o(k,"poly");let u=k;u.getuserdetails();
