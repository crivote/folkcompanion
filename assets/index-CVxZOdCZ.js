var gt=Object.defineProperty;var xe=n=>{throw TypeError(n)};var yt=(n,s,e)=>s in n?gt(n,s,{enumerable:!0,configurable:!0,writable:!0,value:e}):n[s]=e;var o=(n,s,e)=>yt(n,typeof s!="symbol"?s+"":s,e),we=(n,s,e)=>s.has(n)||xe("Cannot "+e);var x=(n,s,e)=>(we(n,s,"read from private field"),e?e.call(n):s.get(n)),Z=(n,s,e)=>s.has(n)?xe("Cannot add the same private member more than once"):s instanceof WeakSet?s.add(n):s.set(n,e),$e=(n,s,e,t)=>(we(n,s,"write to private field"),t?t.call(n,e):s.set(n,e),e);import v from"https://cdn.jsdelivr.net/npm/axios@1.6.5/+esm";import oe from"https://cdn.jsdelivr.net/npm/abcjs@6.2.3/+esm";(function(){const s=document.createElement("link").relList;if(s&&s.supports&&s.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))t(a);new MutationObserver(a=>{for(const r of a)if(r.type==="childList")for(const i of r.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&t(i)}).observe(document,{childList:!0,subtree:!0});function e(a){const r={};return a.integrity&&(r.integrity=a.integrity),a.referrerPolicy&&(r.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?r.credentials="include":a.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function t(a){if(a.ep)return;a.ep=!0;const r=e(a);fetch(a.href,r)}})();var w;const u=class u{static async authcall(s,e){try{const t=await v.post(`${x(u,w)}auth/login`,{email:s,password:e});if(t.status==200)return t.data.authToken;Promise.reject(!1)}catch(t){console.log(t)}}static returnheader(){return{headers:{Authorization:`Bearer ${u.token}`}}}static async getuser(s){u.token=s;const e=await v.get(x(u,w)+"auth/me",u.returnheader());return e.status==200?e.data:(u.token="",!1)}static async getsingletune(s){const e=await v.get(x(u,w)+"tunes/"+s,u.returnheader());return e.status==200?e.data:!1}static async getalltunes(){const s=await v.get(x(u,w)+"tunes",u.returnheader());return s.status==200?s.data:!1}static async gettunebook(){const s=await v.get(x(u,w)+"tunebook",u.returnheader());return s.status==200?s.data:!1}static async addtotunes(s){const e=await v.post(x(u,w)+"tunes",s,u.returnheader());return e.status==200?e.data:!1}static async deletetune(s){return(await v.delete(x(u,w)+"tunes/"+s,u.returnheader())).status==200}static async deletetunebooktune(s){return(await v.delete(x(u,w)+"tunebook/"+s,u.returnheader())).status==200}static async addtotunebook(s){const e=await v.post(x(u,w)+"tunebook",s,u.returnheader());return e.status==200?e.data:!1}static async edittune(s,e){const t=await v.patch(x(u,w)+"tunes/"+s,e,u.returnheader());return t.status==200?t.data:!1}static async edittunebooktune(s,e){const t=await v.patch(x(u,w)+"tunebook/"+s,e,u.returnheader());return t.status==200?t.data:!1}static async addvideo(s){const e=await v.post(x(u,w)+"videos",s,u.returnheader());return e.status==200?e.data:!1}static async getallvideos(){const s=await v.get(x(u,w)+"videos",u.returnheader());return s.status==200?s.data:!1}static async editvideo(s,e){const t=await v.patch(x(u,w)+"videos/"+s,e,u.returnheader());return t.status==200?t.data:!1}static async getsecrets(){const s=await v.get(x(u,w)+"secrets",u.returnheader());return s.status==200?s.data:!1}static async addsuggestion(s){const e=await v.post(x(u,w)+"suggestions",s,u.returnheader());return e.status==200?e.data:!1}static async getallsuggestions(){const s=await v.get(x(u,w)+"suggestions",u.returnheader());return s.status==200?s.data:!1}static async editsuggestion(s,e){const t=await v.patch(x(u,w)+"suggestions/"+s,e,u.returnheader());return t.status==200?t.data:!1}static async getsetbook(){const s=await v.get(x(u,w)+"sets",u.returnheader());return s.status==200?s.data:!1}static async addtosetbook(s){const e=await v.post(x(u,w)+"sets",s,u.returnheader());return e.status==200?e.data:!1}static async editsetbookset(s,e){const t=await v.patch(x(u,w)+"sets/"+s,e,u.returnheader());return t.status==200?t.data:!1}static async addvideotune(s){const e=await v.post(x(u,w)+"videotunes",s,u.returnheader());return e.status==200?e.data:!1}static async editvideotune(s,e){const t=await v.patch(x(u,w)+"videotunes/"+s,e,u.returnheader());return t.status==200?t.data:!1}static async deletevideotune(s){return(await v.delete(x(u,w)+"videotunes/"+s,u.returnheader())).status==200}};w=new WeakMap,Z(u,w,"https://x8ki-letl-twmt.n7.xano.io/api:JIBL7nZM/"),o(u,"token");let L=u;class pe{static async search(s){let e=1,t=await this.singlesearch(s,e),a=t.data.tunes,r=t.data.pages;for(r=r>3?3:r;e<r;)e++,t=await this.singlesearch(s,e),a=a.concat(t.data.tunes);return a}static singlesearch(s,e=1){const t=`https://thesession.org/tunes/search?q=${s}&format=json&page=${e}`;return v.get(t)}static async gettune(s){const e=`https://thesession.org/tunes/${s}?format=json`,t=await v.get(e);if(t.status==200){if(t.data.recordings>0){const a=await this.gettunerecordings(s);t.data.recordings=a.data.recordings}return t.data}return!1}static async gettunerecordings(s){const e=`https://thesession.org/tunes/${s}/recordings?format=json`;return await v.get(e)}}var V,ae;const M=class M{static async search(s,e=5){const t=await v.get(x(M,ae)+"search?query="+s+"&per_page="+e,{headers:{Authorization:x(M,V)}});return t.status==200?t.data.photos.map(i=>i.src.large):[]}static async initialize(){const e=(await L.getsecrets()).find(a=>a.name=="pexels");return $e(M,V,e.value),await M.search("irish folk music")}};V=new WeakMap,ae=new WeakMap,Z(M,V),Z(M,ae,"https://api.pexels.com/v1/");let G=M;class S{constructor(s,e){o(this,"element",null);this.name=s,this.parentel=e}attachAt(s,e=!0,t=this.parentel){e?t.innerHTML=s:t.insertAdjacentHTML("beforeend",s),this.element=t.lastElementChild}replace(s){const e=this.element.cloneNode(!1);e.outerHTML=s,this.element=this.element.parentNode.replaceChild(e,this.element)}hide(){this.element.classList.add("hidden")}show(){this.element.classList.remove("hidden")}remove(){this.element.remove()}}class bt extends S{constructor(s,e){super(s,e),this.setup()}setup(){const s=this.generatehtml();this.attachAt(s),this.element.querySelector("#sendlogin").addEventListener("click",this.action.bind(this))}generatehtml(){return`<div id="${this.name}" class="fixed inset-0 bg-gray-500 
...
`);if(oe.synth.supportsAudio()){const t=oe.renderAbc("*",e)[0];q.midiBuffer=new oe.synth.CreateSynth,q.midiBuffer.init({visualObj:t,options:{}}).then(function(){q.midiBuffer.prime().then(function(){q.midiBuffer.start()})}).catch(function(a){console.warn("Audio problem:",a)})}else console.warn("Audio not supported")}static stopabc(){q.midiBuffer&&q.midiBuffer.stop()}static manageabc(s){s.stopPropagation();const e=s.currentTarget;e instanceof HTMLElement&&(e.dataset.state=="playing"?(e.dataset.state="stop",q.stopabc(),e.querySelector("i").classList.remove("fa-circle-stop"),e.querySelector("i").classList.add("fa-play-circle")):(e.dataset.state="playing",q.playabc(e.dataset.abc),e.querySelector("i").classList.remove("fa-play-circle"),e.querySelector("i").classList.add("fa-circle-stop")))}};o(q,"midiBuffer");let P=q;class h{static generatelinks(s){const e=[];return s&&s.forEach(t=>{let a;switch(t==null?void 0:t.service_name){case"thesession.org":a="https://thesession.org/tunes/"+t.service_ID,e.push(`<a class="bg-yellow-600 px-2 rounded-full text-sm" 
      ...
      <ul class="absolute border border-blue-400 shadow-lg edit-select
        ...
        name="${e}">
            <li>${s.join("</li><li>")}</li>
      </ul>`:""}static getMeanRehear(s){if(Array.isArray(s)&&s.length>1){const e=s.map(i=>new Date(i).getTime());e.reverse();const t=[];for(let i=1;i<e.length;i++){const c=e[i]-e[i-1];t.push(c)}const r=t.reduce((i,c)=>i+c,0)/t.length/(1e3*60*60*24);return Math.round(r)}return null}}class vt extends S{constructor(e,t,a){super(e,t);o(this,"data");o(this,"Thesessionzone");o(this,"videolinks");this.data=a,this.setup()}generatehtml(){var c,d,f,$,A,g,m,E,T,I;const e=(c=this.data)!=null&&c.References&&((d=this.data.References[0])!=null&&d.service_name)?this.data.References.find(j=>j.service_name=="thesession.org"):!1,t=(f=this.data)!=null&&f.References&&(($=this.data.References[0])!=null&&$.service_name)?this.data.References.find(j=>j.service_name=="irishtune.info"):!1,a=(A=this.data)!=null&&A.References&&((g=this.data.References[0])!=null&&g.service_name)?this.data.References.find(j=>j.service_name=="tunearch.org"):!1,r=(m=this.data)!=null&&m.Modes_played&&((E=this.data.Modes_played[0])!=null&&E.key)?this.data.Modes_played.map(j=>j.Key+" "+j.Mode):[];let i="";return e&&(i=`<button class="refreshThesession bg-purple-500 text-white p-2 rounded-md" data-id="${e.service_ID}">Completar datos Thesession</button>`),`<div id="modaledittunemanager" class="fixed inset-0 bg-gray-500 bg-opacity-75 flex items-center justify-center">
      ...
      <p data-target="editsortname">${h.titleforsort(e.name)}</p>
      ...
      <summary class="uppercase text-slate-400 text-sm mt-1">Settings ABC ${c.length}</summary>
        ...
        </div>`}checkcontent(s,e){return s&&Array.isArray(s)&&s.length>0&&s[0]!=null?`<i title="${e}" class="text-green-500 fa fa-check-circle"></i>`:`<i title="${e}" class="text-red-500 fa fa-times-circle"></i>`}edittune(){b.activeScreen instanceof ze&&(b.activeScreen.subelement=new vt("tunemanageredit",b.htmlelement,this.data))}async deletetune(){if(await L.deletetune(this.data.id)){delete l.tunes[this.data.id];const e=b.getinstance("Tunemanager"),t=e.tunes.findIndex(r=>r.id==this.data.id);e.tunes.splice(t,1);const a=e.items.findIndex(r=>r.name=="tune"+this.data.id);e.items.splice(a,1),this.remove()}}}class wt extends S{constructor(e,t,a){super(e,t);o(this,"tunes",[]);o(this,"results");o(this,"details");o(this,"blocked",!1);o(this,"parent");this.parent=a,this.setup()}setup(){this.attachAt(this.generatehtml(),!1),this.addListeners(),this.results=this.element.querySelector(".results"),this.myinfo=this.element.querySelector(".info")}addListeners(){this.element.querySelector("#managertunesearch").addEventListener("input",this.search.bind(this)),this.element.querySelector("#managerclosetunesearch").addEventListener("click",this.hide.bind(this))}generatehtml(){return`<div id="${this.name}" class="fixed inset-0 bg-gray-500 
    bg-opacity-75 flex items-center justify-center">
        ...
        <ul class="results bg-slate-300 text-slate-50 p-2 overflow-auto h-auto">
          ...
          </li>`)}),this.results.querySelectorAll("li.searchitem").forEach(t=>t.addEventListener("click",this.showdetails.bind(this)))}async showdetails(e){const t=e.currentTarget;if(t.dataset.enriched=="false"){t.dataset.enriched="true";const a=t.dataset.id;this.details=await pe.gettune(a);let r=this.details.settings.map(i=>i.key);r=[...new Set(r)],t.insertAdjacentHTML("beforeend",`<div class="details"><p>Alias: 
          ${this.details.aliases.join(" / ")}</p>
                ...
                <i class="fa fa-play-circle fa-lg"></i></span>`),t.querySelector(".playabc").addEventListener("click",P.manageabc),t.querySelector(".addtune").addEventListener("click",this.preparedata.bind(this))}}async search(e){this.results.innerHTML="",this.myinfo.textContent="";const t=e.target.value;if(t.length>6&&!this.blocked){this.blocked=!0;const a=await pe.search(t);a.length>0?(this.myinfo.textContent=`Encontrados ${a.length} resultados:`,this.generateresults(a)):this.myinfo.textContent=`Sin resultados en Thesession para ${t}`,this.blocked=!1}else this.myinfo.textContent="Introduzca al menos 6 caracteres"}checktuneexistindb(e){return l.tunes.some(t=>(t==null?void 0:t.References)&&Array.isArray(t.References)&&t.References.length>0&&t.References.some(a=>(a==null?void 0:a.service_name)=="Thesession.org"&&(a==null?void 0:a.service_ID)==e.toString()))}preparedata(e){const a=e.target.closest(".searchitem");let r=this.details.settings.map(d=>d.key);r=[...new Set(r)],r=r.map(d=>({Key:d.substring(0,1).toUpperCase(),Mode:d.substring(1,2).toUpperCase()+d.substring(2)}));const i=this.normalicetype(this.details.type),c={main_name:this.details.name,sortname:h.titleforsort(this.details.name),other_names:this.details.aliases,popularity:this.details.tunebooks,type:i.type,author:"trad.",time:i.time,References:[{service_name:"thesession.org",service_ID:this.details.id}],Modes_played:r,ABCsample:`L: 1/8
                K:${this.details.settings[0].key}
                ${this.details.settings[0].abc}`};this.savetune(c,a)}normalicetype(e){return e=e.replace(/\b\w/g,t=>t.toUpperCase()),e=="Jig"&&(e="Double Jig"),{type:e,time:l.rythms[e]??""}}async savetune(e,t){try{const a=await L.addtotunes(e);a&&(l.tunes.push(a),this.parent.rendertunes(),t.remove())}catch(a){console.log(a)}}}class ze extends S{constructor(e,t){super(e,t);o(this,"filtered",[]);o(this,"contentzone",null);o(this,"sortcriteria","sortname");o(this,"tuneInstances",[]);o(this,"subelement");this.setup()}setup(){const e=l.tunes.map(r=>r.type);this.typeslist=[...new Set(e)];const t=l.tunes.map(r=>r.tradition);this.originlist=[...new Set(t.flat())],this.filtered=l.tunes;const a=this.generatehtml();this.attachAt(a,!1),this.contentzone=this.element.querySelector("main"),this.addListeners(),this.rendertunes()}generatehtml(){return`
    <section id="${this.name}">
      ...
      <div class="user ml-auto mr-6">
        ...
        </div>`}eliminate(){this.element.classList.remove("animate__fadeInUp"),this.element.classList.add("animate__backOutRight"),this.element.addEventListener("animationend",()=>{this.remove()})}}class Ue extends S{constructor(e,t,a,r="new"){super(e,t);o(this,"tune");o(this,"pics");o(this,"isNew");this.isNew=r=="new";const i=this.isNew?"tunes":"tunebook";this.tune=l[i].find(c=>c.id===a),this.setup()}async setup(){this.pics=await G.search(this.isNew?this.tune.other_names[0]:this.tune.prefered_name),this.pics=this.pics.concat(l.genericpics),this.isNew||this.pics.unshift(this.tune.preferred_img_url),this.attachAt(this.generatehtml(),!1),this.addListeners()}generatehtml(){const e=this.isNew?this.tune:this.tune.tuneref;e.tunekeys=e.Modes_played.map(i=>`${i.Key} ${i.Mode}`);const t=this.isNew?l.status[0].label:h.getstatus(this.tune.status_num).label,a=this.isNew||this.tune.tags.length==0?"":this.tune.tags.join(" "),r=this.isNew||this.tune.notes.trim()==""?"":this.tune.notes;return`
    ...
    flex items-center justify-center">
      ...
      max-h-full overflow-scroll">
        ...
        ${h.generateformfield("titulo","titulo favorito",this.isNew?e.main_name:this.tune.prefered_name,e.other_names)}
        ${h.generateformfield("tonalidad","tonalidad preferida",this.isNew?e.tunekeys[0]:this.tune.prefered_tone,e.tunekeys)}
        ${h.generateformfield("status","status de ejecución",t,l.status.map(i=>i.label))}
              ...
              bg-slate-50 rounded-md mb-4 gap-3 justify-between">
                <div class="flex flex-col">
                    ...
                    name="learneddate" value="${this.isNew?h.dateformat():this.tune.learned_date}">
                </div>
                <div class="flex flex-col">
                    <label class="uppercase text-slate-400 text-sm">
                    ensayos</label>
    ...
    <div id="${this.name}" class="animate__animated animate__slideInLeft
     ...
     shadow-lg">
        ...
        a continuación e intentaremos añadirlo. Gracias!`,a.classList.remove("hidden")),this.generateresults(i)}}generateresults(e){e.length>0?(this.resultszone.classList.remove("hidden"),this.resultszone.innerHTML="",this.resultInstances=e.map(t=>new St("tune"+t.id,this.resultszone,t.id))):this.resultszone.classList.add("hidden")}eliminate(){this.element.classList.remove("animate__slideInLeft"),this.element.classList.add("animate__slideOutLeft"),this.element.addEventListener("animationend",()=>{this.remove();const e=b.getinstance("Tunebook"),t=e.subelements.findIndex(a=>a.name==this.name);e.subelements.splice(t,1)})}async suggestion(e){const t=this.element.querySelector(".titlesuggestion").value;if(t){const a={...l.template.suggestion};a.type_of_suggestion="tune",a.user_id=l.user.id,a.content=t,a.status="waiting",await L.addsuggestion(a)?(this.setup(),new y("success","Se ha guardado su petición.")):(this.data=backup,new y("danger","error al guardar la petición."))}}}class Lt extends S{constructor(s,e,t,a){super(s,e),this.id=t,this.data=l.tunebook.find(r=>r.id===t),this.format=a,this.setup()}setup(){const s=this["generatehtml_"+this.format]();this.element?this.replace(s):this.attachAt(s,!1),this.addlisteners()}addlisteners(){this.element.querySelector(".rehearsal").addEventListener("click",this.addrehearsal.bind(this)),this.element.querySelector(".deletetune").addEventListener("click",this.deletetune.bind(this)),this.element.querySelector(".edittune").addEventListener("click",this.quickedit.bind(this)),this.element.addEventListener("click",this.viewdetails.bind(this)),this.data.tuneref.ABCsample&&this.element.querySelector(".playabc").addEventListener("click",P.manageabc)}generatehtml_card(){var t,a,r;const s=h.getstatus(this.data.status_num),e=h.generatelinks((t=this.data.tuneref)==null?void 0:t.References);return`<div id="tune${this.data.id}" class="group cursor-pointer flex 
    ...
    hover:shadow-lg hover:scale-110 hover:z-40">
        ...
        shadow-2xl z-40" src="./img/${h.removeWhiteSpaces(this.data.prefered_tone.substring(0,5))}.png">
           </span>
        </div>`:""}
        ...
        <p class="text-center text-xs text-slate-800/75 px-2 py-1 uppercase">
            ...
            ${h.calctimesince((a=this.data)==null?void 0:a.last_rehearsals[0])}</span>
        </p>
        <p class="text-center text-xs text-slate-800/75 px-2 py-1 uppercase">
        ...
        uppercase">${e}</span>`}),s}generatehtml_list(){var e;const s=h.getstatus(this.data.status_num);return`<div id="tune${this.data.id}" class="tunelist group w-full bg-white
     border-b-2 border-slate200 rounded-md px-6 py-2 flex items-center gap-2">
      ...
      ${h.calctimesince((e=this.data)==null?void 0:e.last_rehearsals[0])}</p>
      </div>
      <div>
        ...
        <img class="group-hover/item:visible invisible w-42 fixed inset-0 
        h-auto m-auto border border-slate-400 p-4 bg-white/90 rounded-lg 
        shadow-2xl" src="./img/${h.removeWhiteSpaces(this.data.prefered_tone.substring(0,5))}.png">
        </span>
        </h2>
        <p class="tuneadditionaldata text-slate-400 font-regular uppercase 
  ...
  </div>`}async addrehearsal(s){if(s.stopPropagation(),b.addrehearsal(this.data.id)){const t=b.activeScreen;t.rendertunes(t.filtered)}}viewdetails(){}quickedit(){const s=b.activeScreen;s.subelements.push(new Ue("modaltuneedit",s.element,this.data.id,"edit"))}async deletetune(){if(await L.deletetunebooktune(this.data.id)){const e=l.tunebook.findIndex(a=>a.id==this.data.id);l.tunebook.splice(e,1),new y("success",`eliminado el tema ${this.data.prefered_name} del repertorio.`);const t=b.activeScreen;t.rendertunes(t.filtered)}else new y("danger","no se ha podido eliminar el tema.")}}class At extends S{constructor(e,t){super(e,t);o(this,"filtered",[]);o(this,"criterialist",[{value:"titlesort",label:"nombre"},{value:"status_num",label:"status"},{value:"last_rehearsalDate",label:"último ensayo",selected:!0},{value:"prefered_tone",label:"tonalidad"},{value:"rehearsal_days",label:"nº ensayos"}]);o(this,"sortcriteria","last_rehearsalDate");o(this,"sortorder","DESC");o(this,"tune_instances",[]);o(this,"typeslist",[]);o(this,"statuslist",[]);o(this,"toneslist",[]);o(this,"contentzone",null);o(this,"format","card");o(this,"subelements",[]);this.setup()}setup(e=l.tunebook){this.filtered=e;const t=this.generatehtml();this.element?this.replace(t):this.attachAt(t,!1),this.populateFilterOptions(),this.contentzone=this.element.querySelector("main"),this.filterzone=this.element.querySelector(".filtercomponent"),this.filternotice=this.element.querySelector(".filternotice"),this.counter=this.element.querySelector(".tunecounter"),this.addListeners(),this.rendertunes()}addListeners(){this.element.querySelector("#tunebook_filter").addEventListener("input",this.applyFilter.bind(this)),this.element.querySelector("#typetune_filter").addEventListener("change",this.applyFilter.bind(this)),this.element.querySelector("#tonetune_filter").addEventListener("change",this.applyFilter.bind(this)),this.element.querySelector("#statustune_filter").addEventListener("change",this.applyFilter.bind(this)),this.element.querySelector(".resetfilter").addEventListener("click",this.resetFilter.bind(this)),this.element.querySelector(".addnewtune").addEventListener("click",this.launchsearch.bind(this)),this.element.querySelectorAll(".viewselector").forEach(e=>e.addEventListener("click",this.changeview.bind(this))),this.element.querySelector(".tunesorting").addEventListener("change",this.applysort.bind(this)),this.element.querySelector(".sortorder").addEventListener("click",this.changesortorder.bind(this))}rendertunes(){this.contentzone.innerHTML="";const e=this.sorter(this.filtered);this.tune_instances=e.map(t=>new Lt("tune"+t.id,this.contentzone,t.id,this.format))}generatehtml(){return`
    <section id="${this.name}">
      <header class="p-6">
      ...
      <main class="p-6 ${this.format=="card"?"grid gap-6":""}" 
        ...
        </section>`}}let Et=class extends S{constructor(s,e,t){super(s,e),this.id=t,this.data=l.setbook.find(a=>a.id===this.id),this.setup()}setup(){this.attachAt(this.generatehtml(),!1),this.addListeners()}generatehtml(){let s="";return this.data.tunes.forEach(e=>{const t=l.tunebook.find(a=>a.id===e.tunebook_id);t&&(s+=`
    ...
    left-1/3 right-1/3 text-center">${t}</div>`;this.gamezone.insertAdjacentHTML("beforeend",a),this.gamezone.querySelector(".message").addEventListener("click",this.nextturn.bind(this))}}class Se extends S{constructor(e,t,a){super(e,t);o(this,"video");o(this,"tune");o(this,"metatune");this.video=l.videos.find(r=>r.id==a.videoid),this.tune=l.tunes.find(r=>r.id==a.tunes_id),this.setup(),this.metatune=a}async setup(){this.attachAt(this.generatehtml(),!1),this.addListeners()}addListeners(){this.element.querySelector(".removetune").addEventListener("click",this.remove.bind(this))}async remove(){if(this.tune.medialinks&&this.tune.medialinks.some(e=>e.videoid==this.video.id)){this.tune.medialinks=this.tune.medialinks.filter(e=>e.videoid!=this.video.id);try{await L.edittune(this.tune.id,this.tune)&&new y("success",`Se ha borrado referencia al tema ${tune.main_name}.`)}catch(e){new y("danger",`No se ha podido borrar referencia al tema ${tune.main_name}.`),console.log(e)}}super.remove()}generatehtml(){return`
  ...
  ${h.generateformfield("titulo","titulo del vídeo",this.isNew?"":this.video.Title,null,!0)}
  ${h.generateformfield("artista","artista",this.isNew?"":this.video.Performer,null,!0)}
  ${h.generateformfield("type","Categoría de vídeo",this.isNew?"":this.video.type,l.videotypes)}
              <div class="flex flex-col border-2 p-4 border-slate-100 
              bg-slate-50 rounded-md mb-4">
                <label class="uppercase text-slate-400 text-sm">
                Notas</label>   
    ...
    <div>
  </div>`}getfulllistoftunes(){return this.isNew?"":l.tunes.flatMap(t=>{const a=t.id;return t.other_names.map(r=>`<option value="${a}" label="${r}">${r}</option>`)}).join("")}getVideoKey(e){if(e.currentTarget instanceof HTMLInputElement){const t=e.currentTarget.value,a=h.extractYoutubeID(t);a&&(this.videokey=a,this.loadVideo(this.videokey),e.currentTarget.value=this.videokey)}}loadVideo(e){this.videozone.innerHTML=h.videoembed(e),this.element.querySelector(".sendbutton").disabled=!1,this.inputvideo.value=""}async addtunetovideo(e){const t=e.currentTarget,a=t.value;t.value="",this.tunes.push(a),this.instances.push(new Se("tune"+a,this.tuneszone,this.video.id,a))}async addvideo(e){e.preventDefault();const t={url:this.videokey,thumb_url:`https://i3.ytimg.com/vi/${this.videokey}/hqdefault.jpg`,type:this.element.querySelector('[data-name="type"]').textContent,Title:this.element.querySelector('[data-name="titulo"]').textContent,Performer:this.element.querySelector('[data-name="artista"]').textContent,notes:this.element.querySelector('[name="notes"]').textContent,album_relation:{}};if(this.isNew)if(l.videos.some(a=>a.url==this.videokey))new y("danger","Ya hay un video guardado con la misma url.");else try{await L.addvideo(t)&&(new y("success","Se ha guardado el nuevo vídeo."),b.getinstance("Videos").rendervideos(),this.remove())}catch(a){new y("danger","No se ha podido guardar el nuevo vídeo."),console.log(a)}else{t.id=this.video.id;try{await L.editvideo(this.video.id,t)&&(new y("success","Se ha actualizado el vídeo."),this.instances.forEach(i=>i.savevideoreference()),b.getinstance("Videos").rendervideos(),this.remove())}catch(a){new y("danger","No se ha podido actualizar el vídeo."),console.log(a)}}}showeditselect(e){e.currentTarget.querySelector(".edit-select").classList.remove("hidden")}changeselectvalue(e){e.stopImmediatePropagation();const t=e.currentTarget,a=t.parentNode,r=a.previousElementSibling;a.classList.add("hidden"),r.textContent=t.textContent}}class jt extends S{constructor(e,t,a,r){super(e,t);o(this,"parent");this.parent=r,this.id=a,this.data=l.videos.find(i=>i.id===a),this.setup()}setup(){const e=this.generatehtml();this.attachAt(e,!1),this.addlisteners()}addlisteners(){this.element.querySelector(".mythumbvideo").addEventListener("click",this.showvideo.bind(this)),this.element.querySelector(".editbutton").addEventListener("click",this.editvideo.bind(this)),this.element.querySelector(".deletebutton").addEventListener("click",this.deletevideo.bind(this))}gettunedata(e){const t=l.tunes.find(a=>a.id==e);return`<li>${t.main_name} ${t.type}</li>`}generatehtml(){let e="";return this.data.tuneslinks&&this.data.tuneslinks.length>0&&(e=this.data.tuneslinks.map(t=>this.gettunedata(t.tunes_id)).join("")),`<div id="video${this.data.id}" class="videolist 
    ...
    items-top border border-slate-300">
      ...
      </div>`}showvideo(e){const t=e.currentTarget.firstElementChild;t.innerHTML=h.videoembed(this.data.url),t.classList.remove("hidden")}editvideo(){const e=b.getinstance("Videos");e.subelements.push(new He("modalvideoedit",e.element,this.data.id))}deletevideo(){}}class Pt extends S{constructor(e,t){super(e,t);o(this,"items",[]);o(this,"videozone",null);o(this,"subelements",[]);this.setup()}addListeners(){this.element.querySelector(".addnewvideo").addEventListener("click",this.modalnewvideo.bind(this))}async setup(){this.attachAt(this.generatehtml(),!1),this.videozone=this.element.querySelector("main"),this.addListeners(),(!l.videos||l.videos.length===0)&&(l.videos=await L.getallvideos(),l.videos&&l.videos.length>0&&new y("success",`cargados ${l.videos.length} videos.`)),this.rendervideos()}generatehtml(){return`<section id="${this.name}">
      <header class="p-6">
        <div class="flex flex-wrap items-center gap-2">
    ...
    my-3 rounded-md p-4 hover:bg-slate-300 transition cursor-pointer">
      ...
      <span class="font-medium ml-1 text-xs text-slate-400 uppercase">
        ${r.tuneref.type}</span>
           </li>`}),t}show(){this.renderDiary(),super.show()}}class ke extends S{constructor(e,t,a){super(e,t);o(this,"tune");this.tune=a,this.setup()}async setup(){this.attachAt(this.generatehtml(),!1),this.addListeners()}addListeners(){this.element.querySelector(".rehearsal").addEventListener("click",this.addrehearsal.bind(this)),this.tune.tuneref.ABCsample&&this.element.querySelector(".playabc").addEventListener("click",P.manageabc)}generatehtml(){var t;const e=h.generatelinks((t=this.tune.tuneref)==null?void 0:t.References);return`<div id="tuneoriginal${this.tune.id}" class="tunelist group 
      w-full bg-white
      border-b-2 border-slate200 rounded-md px-6 py-2 flex items-center gap-2">
      <div class="tuneimg flex h-20 w-20 bg-center bg-cover mr-3
      ...
      <div>         
        ...
        <img class="group-hover/item:visible invisible w-42 fixed inset-0 
        h-auto m-auto border border-slate-400 p-4 bg-white/90 rounded-lg 
        shadow-2xl" src="./img/${h.removeWhiteSpaces(this.tune.prefered_tone.substring(0,5))}.png">
        </span>
        <span>${e.join("")}</span>
        </h2>
        <p class="tuneadditionaldata text-slate-400 font-regular uppercase 
      ...
      <main class="p-6"></main>
      </section>`}sortTunes(e){return e.sort((a,r)=>r.points!==a.points?r.points-a.points:new Date(r.last_rehearsalDate)-new Date(a.last_rehearsalDate))}sorter(e){const t=e.target.value;this.sortcriteria=t,this.tunelist.sort((a,r)=>{const i=this.sortcriteria=="type"?a.tuneref.type:a[this.sortcriteria],c=this.sortcriteria=="type"?r.tuneref.type:r[this.sortcriteria];return i<c?this.sortorder=="ASC"?-1:1:i>c?this.sortorder=="ASC"?1:-1:0}),this.renderList()}createList(){const e=this.assignPointsTunes();this.tunelist=e.slice(0,this.numberTunes),this.renderList()}renderList(){this.contentZone.innerHTML="",this.tuneinstances=this.tunelist.map(e=>new Mt("tune"+e.id,this.contentZone,e,this.maxRehear))}}const Le=Object.freeze(Object.defineProperty({__proto__:null,Game:qt,Learn:Ot,Login:bt,Menubar:$t,Mynotification:y,Rehear:Dt,Setbook:Tt,Stats:It,Tunebook:At,Tunemanager:ze,Videos:Pt},Symbol.toStringTag,{value:"Module"}));function Ct(n){return n&&n.__esModule&&Object.prototype.hasOwnProperty.call(n,"default")?n.default:n}var Ae=Object.prototype.toString,Ge=function(s){var e=Ae.call(s),t=e==="[object Arguments]";return t||(t=e!=="[object Array]"&&s!==null&&typeof s=="object"&&typeof s.length=="number"&&s.length>=0&&Ae.call(s.callee)==="[object Function]"),t},le,_e;function Rt(){if(_e)return le;_e=1;var n;if(!Object.keys){var s=Object.prototype.hasOwnProperty,e=Object.prototype.toString,t=Ge,a=Object.prototype.propertyIsEnumerable,r=!a.call({toString:null},"toString"),i=a.call(function(){},"prototype"),c=["toString","toLocaleString","valueOf","hasOwnProperty","isPrototypeOf","propertyIsEnumerable","constructor"],d=function(g){var m=g.constructor;return m&&m.prototype===g},f={$applicationCache:!0,$console:!0,$external:!0,$frame:!0,$frameElement:!0,$frames:!0,$innerHeight:!0,$innerWidth:!0,$onmozfullscreenchange:!0,$onmozfullscreenerror:!0,$outerHeight:!0,$outerWidth:!0,$pageXOffset:!0,$pageYOffset:!0,$parent:!0,$scrollLeft:!0,$scrollTop:!0,$scrollX:!0,$scrollY:!0,$self:!0,$webkitIndexedDB:!0,$webkitStorageInfo:!0,$window:!0},$=function(){if(typeof window>"u")return!1;for(var g in window)try{if(!f["$"+g]&&s.call(window,g)&&window[g]!==null&&typeof window[g]=="object")try{d(window[g])}catch{return!0}}catch{return!0}return!1}(),A=function(g){if(typeof window>"u"||!$)return d(g);try{return d(g)}catch{return!1}};n=function(m){var E=m!==null&&typeof m=="object",T=e.call(m)==="[object Function]",I=t(m),j=E&&e.call(m)==="[object String]",U=[];if(!E&&!T&&!I)throw new TypeError("Object.keys called on a non-object");var mt=i&&T;if(j&&m.length>0&&!s.call(m,0))for(var re=0;re<m.length;++re)U.push(String(re));if(I&&m.length>0)for(var ne=0;ne<m.length;++ne)U.push(String(ne));else for(var ie in m)!(mt&&ie==="prototype")&&s.call(m,ie)&&U.push(String(ie));if(r)for(var ft=A(m),H=0;H<c.length;++H)!(ft&&c[H]==="constructor")&&s.call(m,c[H])&&U.push(c[H]);return U}}return le=n,le}var Bt=Array.prototype.slice,Ft=Ge,Ee=Object.keys,Q=Ee?function(s){return Ee(s)}:Rt(),Te=Object.keys;Q.shim=function(){if(Object.keys){var s=function(){var e=Object.keys(arguments);return e&&e.length===arguments.length}(1,2);s||(Object.keys=function(t){return Ft(t)?Te(Bt.call(t)):Te(t)})}else Object.keys=Q;return Object.keys||Q};var Nt=Q,zt=Error,Ut=EvalError,Ht=RangeError,Gt=ReferenceError,Ve=SyntaxError,W=TypeError,Vt=URIError,Wt=function(){if(typeof Symbol!="function"||typeof Object.getOwnPropertySymbols!="function")return!1;if(typeof Symbol.iterator=="symbol")return!0;var s={},e=Symbol("test"),t=Object(e);if(typeof e=="string"||Object.prototype.toString.call(e)!=="[object Symbol]"||Object.prototype.toString.call(t)!=="[object Symbol]")return!1;var a=42;s[e]=a;for(e in s)return!1;if(typeof Object.keys=="function"&&Object.keys(s).length!==0||typeof Object.getOwnPropertyNames=="function"&&Object.getOwnPropertyNames(s).length!==0)return!1;var r=Object.getOwnPropertySymbols(s);if(r.length!==1||r[0]!==e||!Object.prototype.propertyIsEnumerable.call(s,e))return!1;if(typeof Object.getOwnPropertyDescriptor=="function"){var i=Object.getOwnPropertyDescriptor(s,e);if(i.value!==a||i.enumerable!==!0)return!1}return!0},qe=typeof Symbol<"u"&&Symbol,Kt=Wt,Jt=function(){return typeof qe!="function"||typeof Symbol!="function"||typeof qe("foo")!="symbol"||typeof Symbol("bar")!="symbol"?!1:Kt()},ce={__proto__:null,foo:{}},Zt=Object,Yt=function(){return{__proto__:ce}.foo===ce.foo&&!(ce instanceof Zt)},Qt="Function.prototype.bind called on incompatible ",Xt=Object.prototype.toString,es=Math.max,ts="[object Function]",je=function(s,e){for(var t=[],a=0;a<s.length;a+=1)t[a]=s[a];for(var r=0;r<e.length;r+=1)t[r+s.length]=e[r];return t},ss=function(s,e){for(var t=[],a=e,r=0;a<s.length;a+=1,r+=1)t[r]=s[a];return t},as=function(n,s){for(var e="",t=0;t<n.length;t+=1)e+=n[t],t+1<n.length&&(e+=s);return e},rs=function(s){var e=this;if(typeof e!="function"||Xt.apply(e)!==ts)throw new TypeError(Qt+e);for(var t=ss(arguments,1),a,r=function(){if(this instanceof a){var $=e.apply(this,je(t,arguments));return Object($)===$?$:this}return e.apply(s,je(t,arguments))},i=es(0,e.length-t.length),c=[],d=0;d<i;d++)c[d]="$"+d;if(a=Function("binder","return function ("+as(c,",")+"){ return binder.apply(this,arguments); }")(r),e.prototype){var f=function(){};f.prototype=e.prototype,a.prototype=new f,f.prototype=null}return a},ns=rs,ge=Function.prototype.bind||ns,is=Function.prototype.call,os=Object.prototype.hasOwnProperty,ls=ge,We=ls.call(is,os),p,cs=zt,ds=Ut,us=Ht,hs=Gt,z=Ve,N=W,ps=Vt,Ke=Function,de=function(n){try{return Ke('"use strict"; return ('+n+").constructor;")()}catch{}},O=Object.getOwnPropertyDescriptor;if(O)try{O({},"")}catch{O=null}var ue=function(){throw new N},ms=O?function(){try{return arguments.callee,ue}catch{try{return O(arguments,"callee").get}catch{return ue}}}():ue,R=Jt(),fs=Yt(),_=Object.getPrototypeOf||(fs?function(n){return n.__proto__}:null),F={},gs=typeof Uint8Array>"u"||!_?p:_(Uint8Array),C={__proto__:null,"%AggregateError%":typeof AggregateError>"u"?p:AggregateError,"%Array%":Array,"%ArrayBuffer%":typeof ArrayBuffer>"u"?p:ArrayBuffer,"%ArrayIteratorPrototype%":R&&_?_([][Symbol.iterator]()):p,"%AsyncFromSyncIteratorPrototype%":p,"%AsyncFunction%":F,"%AsyncGenerator%":F,"%AsyncGeneratorFunction%":F,"%AsyncIteratorPrototype%":F,"%Atomics%":typeof Atomics>"u"?p:Atomics,"%BigInt%":typeof BigInt>"u"?p:BigInt,"%BigInt64Array%":typeof BigInt64Array>"u"?p:BigInt64Array,"%BigUint64Array%":typeof BigUint64Array>"u"?p:BigUint64Array,"%Boolean%":Boolean,"%DataView%":typeof DataView>"u"?p:DataView,"%Date%":Date,"%decodeURI%":decodeURI,"%decodeURIComponent%":decodeURIComponent,"%encodeURI%":encodeURI,"%encodeURIComponent%":encodeURIComponent,"%Error%":cs,"%eval%":eval,"%EvalError%":ds,"%Float32Array%":typeof Float32Array>"u"?p:Float32Array,"%Float64Array%":typeof Float64Array>"u"?p:Float64Array,"%FinalizationRegistry%":typeof FinalizationRegistry>"u"?p:FinalizationRegistry,"%Function%":Ke,"%GeneratorFunction%":F,"%Int8Array%":typeof Int8Array>"u"?p:Int8Array,"%Int16Array%":typeof Int16Array>"u"?p:Int16Array,"%Int32Array%":typeof Int32Array>"u"?p:Int32Array,"%isFinite%":isFinite,"%isNaN%":isNaN,"%IteratorPrototype%":R&&_?_(_([][Symbol.iterator]())):p,"%JSON%":typeof JSON=="object"?JSON:p,"%Map%":typeof Map>"u"?p:Map,"%MapIteratorPrototype%":typeof Map>"u"||!R||!_?p:_(new Map()[Symbol.iterator]()),"%Math%":Math,"%Number%":Number,"%Object%":Object,"%parseFloat%":parseFloat,"%parseInt%":parseInt,"%Promise%":typeof Promise>"u"?p:Promise,"%Proxy%":typeof Proxy>"u"?p:Proxy,"%RangeError%":us,"%ReferenceError%":hs,"%Reflect%":typeof Reflect>"u"?p:Reflect,"%RegExp%":RegExp,"%Set%":typeof Set>"u"?p:Set,"%SetIteratorPrototype%":typeof Set>"u"||!R||!_?p:_(new Set()[Symbol.iterator]()),"%SharedArrayBuffer%":typeof SharedArrayBuffer>"u"?p:SharedArrayBuffer,"%String%":String,"%StringIteratorPrototype%":R&&_?_(""[Symbol.iterator]()):p,"%Symbol%":R?Symbol:p,"%SyntaxError%":z,"%ThrowTypeError%":ms,"%TypedArray%":gs,"%TypeError%":N,"%Uint8Array%":typeof Uint8Array>"u"?p:Uint8Array,"%Uint8ClampedArray%":typeof Uint8ClampedArray>"u"?p:Uint8ClampedArray,"%Uint16Array%":typeof Uint16Array>"u"?p:Uint16Array,"%Uint32Array%":typeof Uint32Array>"u"?p:Uint32Array,"%URIError%":ps,"%WeakMap%":typeof WeakMap>"u"?p:WeakMap,"%WeakRef%":typeof WeakRef>"u"?p:WeakRef,"%WeakSet%":typeof WeakSet>"u"?p:WeakSet};if(_)try{null.error}catch(n){var ys=_(_(n));C["%Error.prototype%"]=ys}var bs=function n(s){var e;if(s==="%AsyncFunction%")e=de("async function () {}");else if(s==="%GeneratorFunction%")e=de("function* () {}");else if(s==="%AsyncGeneratorFunction%")e=de("async function* () {}");else if(s==="%AsyncGenerator%"){var t=n("%AsyncGeneratorFunction%");t&&(e=t.prototype)}else if(s==="%AsyncIteratorPrototype%"){var a=n("%AsyncGenerator%");a&&_&&(e=_(a.prototype))}return C[s]=e,e},Pe={__proto__:null,"%ArrayBufferPrototype%":["ArrayBuffer","prototype"],"%ArrayPrototype%":["Array","prototype"],"%ArrayProto_entries%":["Array","prototype","entries"],"%ArrayProto_forEach%":["Array","prototype","forEach"],"%ArrayProto_keys%":["Array","prototype","keys"],"%ArrayProto_values%":["Array","prototype","values"],"%AsyncFunctionPrototype%":["AsyncFunction","prototype"],"%AsyncGenerator%":["AsyncGeneratorFunction","prototype"],"%AsyncGeneratorPrototype%":["AsyncGeneratorFunction","prototype","prototype"],"%BooleanPrototype%":["Boolean","prototype"],"%DataViewPrototype%":["DataView","prototype"],"%DatePrototype%":["Date","prototype"],"%ErrorPrototype%":["Error","prototype"],"%EvalErrorPrototype%":["EvalError","prototype"],"%Float32ArrayPrototype%":["Float32Array","prototype"],"%Float64ArrayPrototype%":["Float64Array","prototype"],"%FunctionPrototype%":["Function","prototype"],"%Generator%":["GeneratorFunction","prototype"],"%GeneratorPrototype%":["GeneratorFunction","prototype","prototype"],"%Int8ArrayPrototype%":["Int8Array","prototype"],"%Int16ArrayPrototype%":["Int16Array","prototype"],"%Int32ArrayPrototype%":["Int32Array","prototype"],"%JSONParse%":["JSON","parse"],"%JSONStringify%":["JSON","stringify"],"%MapPrototype%":["Map","prototype"],"%NumberPrototype%":["Number","prototype"],"%ObjectPrototype%":["Object","prototype"],"%ObjProto_toString%":["Object","prototype","toString"],"%ObjProto_valueOf%":["Object","prototype","valueOf"],"%PromisePrototype%":["Promise","prototype"],"%PromiseProto_then%":["Promise","prototype","then"],"%Promise_all%":["Promise","all"],"%Promise_reject%":["Promise","reject"],"%Promise_resolve%":["Promise","resolve"],"%RangeErrorPrototype%":["RangeError","prototype"],"%ReferenceErrorPrototype%":["ReferenceError","prototype"],"%RegExpPrototype%":["RegExp","prototype"],"%SetPrototype%":["Set","prototype"],"%SharedArrayBufferPrototype%":["SharedArrayBuffer","prototype"],"%StringPrototype%":["String","prototype"],"%SymbolPrototype%":["Symbol","prototype"],"%SyntaxErrorPrototype%":["SyntaxError","prototype"],"%TypedArrayPrototype%":["TypedArray","prototype"],"%TypeErrorPrototype%":["TypeError","prototype"],"%Uint8ArrayPrototype%":["Uint8Array","prototype"],"%Uint8ClampedArrayPrototype%":["Uint8ClampedArray","prototype"],"%Uint16ArrayPrototype%":["Uint16Array","prototype"],"%Uint32ArrayPrototype%":["Uint32Array","prototype"],"%URIErrorPrototype%":["URIError","prototype"],"%WeakMapPrototype%":["WeakMap","prototype"],"%WeakSetPrototype%":["WeakSet","prototype"]},K=ge,te=We,vs=K.call(Function.call,Array.prototype.concat),xs=K.call(Function.apply,Array.prototype.splice),Ie=K.call(Function.call,String.prototype.replace),se=K.call(Function.call,String.prototype.slice),ws=K.call(Function.call,RegExp.prototype.exec),$s=/[^%.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(?:\.|\[\])(?:\.|\[\]|%$))/g,Ss=/\\(\\)?/g,ks=function(s){var e=se(s,0,1),t=se(s,-1);if(e==="%"&&t!=="%")throw new z("invalid intrinsic syntax, expected closing `%`");if(t==="%"&&e!=="%")throw new z("invalid intrinsic syntax, expected opening `%`");var a=[];return Ie(s,$s,function(r,i,c,d){a[a.length]=c?Ie(d,Ss,"$1"):i||r}),a},Ls=function(s,e){var t=s,a;if(te(Pe,t)&&(a=Pe[t],t="%"+a[0]+"%"),te(C,t)){var r=C[t];if(r===F&&(r=bs(t)),typeof r>"u"&&!e)throw new N("intrinsic "+s+" exists, but is not available. Please file an issue!");return{alias:a,name:t,value:r}}throw new z("intrinsic "+s+" does not exist!")},J=function(s,e){if(typeof s!="string"||s.length===0)throw new N("intrinsic name must be a non-empty string");if(arguments.length>1&&typeof e!="boolean")throw new N('"allowMissing" argument must be a boolean');if(ws(/^%?[^%]*%?$/,s)===null)throw new z("`%` may not be present anywhere but at the beginning and end of the intrinsic name");var t=ks(s),a=t.length>0?t[0]:"",r=Ls("%"+a+"%",e),i=r.name,c=r.value,d=!1,f=r.alias;f&&(a=f[0],xs(t,vs([0,1],f)));for(var $=1,A=!0;$<t.length;$+=1){var g=t[$],m=se(g,0,1),E=se(g,-1);if((m==='"'||m==="'"||m==="`"||E==='"'||E==="'"||E==="`")&&m!==E)throw new z("property names with quotes must have matching quotes");if((g==="constructor"||!A)&&(d=!0),a+="."+g,i="%"+a+"%",te(C,i))c=C[i];else if(c!=null){if(!(g in c)){if(!e)throw new N("base intrinsic for "+s+" exists, but the property is not available.");return}if(O&&$+1>=t.length){var T=O(c,g);A=!!T,A&&"get"in T&&!("originalValue"in T.get)?c=T.get:c=c[g]}else A=te(c,g),c=c[g];A&&!d&&(C[i]=c)}}return c},he,De;function ye(){if(De)return he;De=1;var n=J,s=n("%Object.defineProperty%",!0)||!1;if(s)try{s({},"a",{value:1})}catch{s=!1}return he=s,he}var As=J,X=As("%Object.getOwnPropertyDescriptor%",!0);if(X)try{X([],"length")}catch{X=null}var Je=X,Me=ye(),_s=Ve,B=W,Oe=Je,Ze=function(s,e,t){if(!s||typeof s!="object"&&typeof s!="function")throw new B("`obj` must be an object or a function`");if(typeof e!="string"&&typeof e!="symbol")throw new B("`property` must be a string or a symbol`");if(arguments.length>3&&typeof arguments[3]!="boolean"&&arguments[3]!==null)throw new B("`nonEnumerable`, if provided, must be a boolean or null");if(arguments.length>4&&typeof arguments[4]!="boolean"&&arguments[4]!==null)throw new B("`nonWritable`, if provided, must be a boolean or null");if(arguments.length>5&&typeof arguments[5]!="boolean"&&arguments[5]!==null)throw new B("`nonConfigurable`, if provided, must be a boolean or null");if(arguments.length>6&&typeof arguments[6]!="boolean")throw new B("`loose`, if provided, must be a boolean");var a=arguments.length>3?arguments[3]:null,r=arguments.length>4?arguments[4]:null,i=arguments.length>5?arguments[5]:null,c=arguments.length>6?arguments[6]:!1,d=!!Oe&&Oe(s,e);if(Me)Me(s,e,{configurable:i===null&&d?d.configurable:!i,enumerable:a===null&&d?d.enumerable:!a,value:t,writable:r===null&&d?d.writable:!r});else if(c||!a&&!r&&!i)s[e]=t;else throw new _s("This environment does not support defining a property as non-configurable, non-writable, or non-enumerable.")},me=ye(),Ye=function(){return!!me};Ye.hasArrayLengthDefineBug=function(){if(!me)return null;try{return me([],"length",{value:1}).length!==1}catch{return!0}};var Qe=Ye,Es=Nt,Ts=typeof Symbol=="function"&&typeof Symbol("foo")=="symbol",qs=Object.prototype.toString,js=Array.prototype.concat,Ce=Ze,Ps=function(n){return typeof n=="function"&&qs.call(n)==="[object Function]"},Xe=Qe(),Is=function(n,s,e,t){if(s in n){if(t===!0){if(n[s]===e)return}else if(!Ps(t)||!t())return}Xe?Ce(n,s,e,!0):Ce(n,s,e)},et=function(n,s){var e=arguments.length>2?arguments[2]:{},t=Es(s);Ts&&(t=js.call(t,Object.getOwnPropertySymbols(s)));for(var a=0;a<t.length;a+=1)Is(n,t[a],s[t[a]],e[t[a]])};et.supportsDescriptors=!!Xe;var tt=et,st={exports:{}},Ds=J,Re=Ze,Ms=Qe(),Be=Je,Fe=W,Os=Ds("%Math.floor%"),Cs=function(s,e){if(typeof s!="function")throw new Fe("`fn` is not a function");if(typeof e!="number"||e<0||e>4294967295||Os(e)!==e)throw new Fe("`length` must be a positive 32-bit integer");var t=arguments.length>2&&!!arguments[2],a=!0,r=!0;if("length"in s&&Be){var i=Be(s,"length");i&&!i.configurable&&(a=!1),i&&!i.writable&&(r=!1)}return(a||r||!t)&&(Ms?Re(s,"length",e,!0,!0):Re(s,"length",e)),s};(function(n){var s=ge,e=J,t=Cs,a=W,r=e("%Function.prototype.apply%"),i=e("%Function.prototype.call%"),c=e("%Reflect.apply%",!0)||s.call(i,r),d=ye(),f=e("%Math.max%");n.exports=function(g){if(typeof g!="function")throw new a("a function is required");var m=c(s,i,arguments);return t(m,1+f(0,g.length-(arguments.length-1)),!0)};var $=function(){return c(s,r,arguments)};d?d(n.exports,"apply",{value:$}):n.exports.apply=$})(st);var at=st.exports,Rs=W,Bs=function(s){if(s==null)throw new Rs(arguments.length>0&&arguments[1]||"Cannot call method on "+s);return s},rt=J,nt=at,Fs=nt(rt("String.prototype.indexOf")),Ns=function(s,e){var t=rt(s,!!e);return typeof t=="function"&&Fs(s,".prototype.")>-1?nt(t):t},zs=Bs,it=Ns,Us=it("Object.prototype.propertyIsEnumerable"),Hs=it("Array.prototype.push"),ot=function(s){var e=zs(s),t=[];for(var a in e)Us(e,a)&&Hs(t,[a,e[a]]);return t},Gs=ot,lt=function(){return typeof Object.entries=="function"?Object.entries:Gs},Vs=lt,Ws=tt,Ks=function(){var s=Vs();return Ws(Object,{entries:s},{entries:function(){return Object.entries!==s}}),s},Js=tt,Zs=at,Ys=ot,ct=lt,Qs=Ks,dt=Zs(ct(),Object);Js(dt,{getPolyfill:ct,implementation:Ys,shim:Qs});var Xs=dt,be=Xs,ut=We,ea=function(s){},fe=String.prototype.replace,ht=String.prototype.split,ee="||||",Y=function(n){var s=n%100,e=s%10;return s!==11&&e===1?0:2<=e&&e<=4&&!(s>=12&&s<=14)?1:2},pt={pluralTypes:{arabic:function(n){if(n<3)return n;var s=n%100;return s>=3&&s<=10?3:s>=11?4:5},bosnian_serbian:Y,chinese:function(){return 0},croatian:Y,french:function(n){return n>=2?1:0},german:function(n){return n!==1?1:0},russian:Y,lithuanian:function(n){return n%10===1&&n%100!==11?0:n%10>=2&&n%10<=9&&(n%100<11||n%100>19)?1:2},czech:function(n){return n===1?0:n>=2&&n<=4?1:2},polish:function(n){if(n===1)return 0;var s=n%10;return 2<=s&&s<=4&&(n%100<10||n%100>=20)?1:2},icelandic:function(n){return n%10!==1||n%100===11?1:0},slovenian:function(n){var s=n%100;return s===1?0:s===2?1:s===3||s===4?2:3},romanian:function(n){if(n===1)return 0;var s=n%100;return n===0||s>=2&&s<=19?1:2},ukrainian:Y},pluralTypeToLanguages:{arabic:["ar"],bosnian_serbian:["bs-Latn-BA","bs-Cyrl-BA","srl-RS","sr-RS"],chinese:["id","id-ID","ja","ko","ko-KR","lo","ms","th","th-TH","zh"],croatian:["hr","hr-HR"],german:["fa","da","de","en","es","fi","el","he","hi-IN","hu","hu-HU","it","nl","no","pt","sv","tr"],french:["fr","tl","pt-br"],russian:["ru","ru-RU"],lithuanian:["lt"],czech:["cs","cs-CZ","sk"],polish:["pl"],icelandic:["is","mk"],slovenian:["sl-SL"],romanian:["ro"],ukrainian:["uk","ua"]}};function ta(n){for(var s={},e=be(n),t=0;t<e.length;t+=1)for(var a=e[t][0],r=e[t][1],i=0;i<r.length;i+=1)s[r[i]]=a;return s}function sa(n,s){var e=ta(n.pluralTypeToLanguages);return e[s]||e[ht.call(s,/-/,1)[0]]||e.en}function aa(n,s,e){return n.pluralTypes[s](e)}function ra(){var n={};return function(s,e){var t=n[e];return t&&!s.pluralTypes[t]&&(t=null,n[e]=t),t||(t=sa(s,e),t&&(n[e]=t)),t}}function Ne(n){return n.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")}function na(n){var s=n&&n.prefix||"%{",e=n&&n.suffix||"}";if(s===ee||e===ee)throw new RangeError('"'+ee+'" token is reserved for pluralization');return new RegExp(Ne(s)+"(.*?)"+Ne(e),"g")}var ia=ra(),oa=/%\{(.*?)\}/g;function ve(n,s,e,t,a,r){if(typeof n!="string")throw new TypeError("Polyglot.transformPhrase expects argument #1 to be string");if(s==null)return n;var i=n,c=t||oa,d=r||fe,f=typeof s=="number"?{smart_count:s}:s;if(f.smart_count!=null&&n){var $=a||pt,A=ht.call(n,ee),g=e||"en",m=ia($,g),E=aa($,m,f.smart_count);i=fe.call(A[E]||A[0],/^[^\S]*|[^\S]*$/g,"")}return i=d.call(i,c,function(T,I){return!ut(f,I)||f[I]==null?T:f[I]}),i}function D(n){var s=n||{};this.phrases={},this.extend(s.phrases||{}),this.currentLocale=s.locale||"en";var e=s.allowMissing?ve:null;this.onMissingKey=typeof s.onMissingKey=="function"?s.onMissingKey:e,this.warn=s.warn||ea,this.replaceImplementation=s.replace||fe,this.tokenRegex=na(s.interpolation),this.pluralRules=s.pluralRules||pt}D.prototype.locale=function(n){return n&&(this.currentLocale=n),this.currentLocale};D.prototype.extend=function(n,s){for(var e=be(n||{}),t=0;t<e.length;t+=1){var a=e[t][0],r=e[t][1],i=s?s+"."+a:a;typeof r=="object"?this.extend(r,i):this.phrases[i]=r}};D.prototype.unset=function(n,s){if(typeof n=="string")delete this.phrases[n];else for(var e=be(n||{}),t=0;t<e.length;t+=1){var a=e[t][0],r=e[t][1],i=s?s+"."+a:a;typeof r=="object"?this.unset(r,i):delete this.phrases[i]}};D.prototype.clear=function(){this.phrases={}};D.prototype.replace=function(n){this.clear(),this.extend(n)};D.prototype.t=function(n,s){var e,t,a=s??{};if(typeof this.phrases[n]=="string")e=this.phrases[n];else if(typeof a._=="string")e=a._;else if(this.onMissingKey){var r=this.onMissingKey;t=r(n,a,this.currentLocale,this.tokenRegex,this.pluralRules,this.replaceImplementation)}else this.warn('Missing translation for key: "'+n+'"'),t=n;return typeof e=="string"&&(t=ve(e,a,this.currentLocale,this.tokenRegex,this.pluralRules,this.replaceImplementation)),t};D.prototype.has=function(n){return ut(this.phrases,n)};D.transformPhrase=function(s,e,t){return ve(s,e,t)};var la=D;const ca=Ct(la),da={token:{token_ok:"Valid token, user data retrieved.",token_ko:"The saved token is not valid."},login:{title:"Log In",email:"Email",pass:"Password",login:"Login",new_user:"Do you want to create a new account?",required_mail:"Email is required",required_pass:"Enter password",login_error:"Login error"},menubar:{manager:"temas",videos:"videos",suggest:"peticiones",book:"repertorio",sets:"sets",learn:"aprender",practice:"ensayar",game:"juego",stats:"historial"}},ua={token:{token_ok:"token válido, datos de usuario recuperados.",token_ko:"el token guardado no es válido."},login:{title:"Inicio de Sesión",email:"Correo Electrónico",pass:"Contraseña",login:"Iniciar Sesión",new_user:"¿Desea crear una cuenta nueva?",required_mail:"Email obligatorio",required_pass:"Introduce contraseña",login_error:"Error en login"},menubar:{manager:"temas",videos:"videos",suggest:"peticiones",book:"repertorio",sets:"sets",learn:"aprender",practice:"ensayar",game:"juego",stats:"historial"}},k=class k{static getinstance(s){if(Object.hasOwn(Le,s)){const e=s==="Menubar"?k.menuelement:k.htmlelement,t=new Le[s](s,e);return s!=="Menubar"&&(k.activeScreen=t),t}}static async getuserdetails(){k.poly=new ca({phrases:da});const s=localStorage.getItem("token");if(s)try{const e=await L.getuser(s);l.user=e,l.user.lang!=="en"&&k.poly.replace(ua),new y("success",k.poly.t("token.token_ok")),k.startapp()}catch{new y("warning",k.poly.t("token.token_ko")),localStorage.removeItem("token"),k.getinstance("Login")}else k.getinstance("Login")}static async startapp(){await k.loadAlltunes(),k.getinstance("Menubar")}static async loadGenericPics(){if(l.genericpics=await G.initialize(),l.genericpics&&l.genericpics.length>0)return new y("success",`cargadas ${l.genericpics.length} imagenes genéricas.`),!0;new y("danger","error al cargar fotos genericas.")}static async loadAlltunes(){if(l.tunes=await L.getalltunes(),l.tunes&&l.tunes.length>0)return l.tunes.forEach(s=>{s!=null&&s.other_names?s.other_names.includes(s.main_name)||s.other_names.push(s.main_name):s.other_names=[s.main_name],(!s.sortname||s.sortname.length==0)&&(s.sortname=h.titleforsort(s.main_name))}),new y("success",`cargados ${l.tunes.length} temas.`),await k.loadUserTunebook(),!0;new y("danger","error al cargar todos los temas.")}static async loadUserTunebook(){return l.tunebook=await L.gettunebook(),l.tunebook&&l.tunebook.length>0?(l.tunebook.forEach(s=>{s.tuneref=l.tunes.find(e=>e.id===s.tunes_id),h.calcValueforTunes(s)}),new y("success",`cargados ${l.tunebook.length} temas de tu repertorio.`),await k.loadUserSetbook(),!0):(new y("info","no tienes nada en tu repertorio."),!0)}static async loadUserSetbook(){return l.setbook=await L.getsetbook(),l.setbook&&l.setbook.length>0?(new y("success",`cargados ${l.setbook.length} sets de tu repertorio.`),!0):(new y("info","no tienes ningun set."),!0)}static async addrehearsal(s){let e=l.tunebook.find(i=>i.id==s);const t=JSON.parse(JSON.stringify(e));Array.isArray(e.last_rehearsals)||(e.last_rehearsals=[]);const a=new Date;return e.last_rehearsalDate=a.valueOf(),e.last_rehearsals.unshift(e.last_rehearsalDate),e.last_rehearsals.length>10&&(e.last_rehearsals=e.last_rehearsals.slice(0,10)),e.rehearsal_days++,await L.edittunebooktune(s,e)?(h.calcValueforTunes(e),new y("success",`añadido nuevo ensayo de ${e.prefered_name}.`),!0):(e=t,new y("danger","error al guardar el ensayo."),!1)}static async changeStatus(s,e){const t=l.tunebook.find(i=>i.id==s);t.status_num=e;const a=await L.edittunebooktune(s,t),r=h.getstatus(e);return a?(new y("success",`cambiado status de ${t.prefered_name} a ${r.label}`),!0):(new y("danger","error al cambiar status."),!1)}};o(k,"htmlelement",document.getElementById("app")),o(k,"menuelement",document.getElementById("menuholder")),o(k,"activeScreen"),o(k,"midiBuffer"),o(k,"player"),o(k,"searchtunes",[]),o(k,"poly");let b=k;b.getuserdetails();
