...
`);if(le.synth.supportsAudio()){const t=le.renderAbc("*",e)[0];q.midiBuffer=new le.synth.CreateSynth,q.midiBuffer.init({visualObj:t,options:{}}).then(function(){q.midiBuffer.prime().then(function(){q.midiBuffer.start()})}).catch(function(a){console.warn("Audio problem:",a)})}else console.warn("Audio not supported")}static stopabc(){q.midiBuffer&&q.midiBuffer.stop()}static manageabc(s){s.stopPropagation();const e=s.currentTarget;e instanceof HTMLElement&&(e.dataset.state=="playing"?(e.dataset.state="stop",q.stopabc(),e.querySelector("i").classList.remove("fa-circle-stop"),e.querySelector("i").classList.add("fa-play-circle")):(e.dataset.state="playing",q.playabc(e.dataset.abc),e.querySelector("i").classList.remove("fa-play-circle"),e.querySelector("i").classList.add("fa-circle-stop")))}};o(q,"midiBuffer");let P=q;class h{static generatelinks(s){const e=[];return s&&s.forEach(t=>{let a;switch(t==null?void 0:t.service_name){case"thesession.org":a="https://thesession.org/tunes/"+t.service_ID,e.push(`<a class="bg-yellow-600 px-2 rounded-full text-sm" 
    ...
    <section id="${this.name}">
      ...
      <div class="user ml-auto mr-6">
        ...
        </div>`}eliminate(){this.element.classList.remove("animate__fadeInUp"),this.element.classList.add("animate__backOutRight"),this.element.addEventListener("animationend",()=>{this.remove()})}}class ze extends S{constructor(e,t,a,r="new"){super(e,t);o(this,"tune");o(this,"pics");o(this,"isNew");this.isNew=r=="new";const i=this.isNew?"tunes":"tunebook";this.tune=l[i].find(c=>c.id===a),this.setup()}async setup(){this.pics=await G.search(this.isNew?this.tune.other_names[0]:this.tune.prefered_name),this.pics=this.pics.concat(l.genericpics),this.isNew||this.pics.unshift(this.tune.preferred_img_url),this.attachAt(this.generatehtml(),!1),this.addListeners()}generatehtml(){const e=this.isNew?this.tune:this.tune.tuneref;e.tunekeys=e.Modes_played.map(i=>`${i.Key} ${i.Mode}`);const t=this.isNew?l.status[0].label:h.getstatus(this.tune.status_num).label,a=this.isNew||this.tune.tags.length==0?"":this.tune.tags.join(" "),r=this.isNew||this.tune.notes.trim()==""?"":this.tune.notes;return`
    ...
    <section id="${this.name}">
      ...
      <main class="p-6 ${this.format=="card"?"grid gap-6":""}" 
        ...
        </section>`}}let _t=class extends S{constructor(s,e,t){super(s,e),this.id=t,this.data=l.setbook.find(a=>a.id===this.id),this.setup()}setup(){this.attachAt(this.generatehtml(),!1),this.addListeners()}generatehtml(){let s="";return this.data.tunes.forEach(e=>{const t=l.tunebook.find(a=>a.id===e.tunebook_id);t&&(s+=`
  ...
  ${h.generateformfield("type","Categoría de vídeo",this.isNew?"":this.video.type,l.videotypes)}
    ...
    my-3 rounded-md p-4 hover:bg-slate-300 transition cursor-pointer">
      ...
      <main class="p-6"></main>
      </section>`}sortTunes(e){return e.sort((a,r)=>r.points!==a.points?r.points-a.points:new Date(r.last_rehearsalDate)-new Date(a.last_rehearsalDate))}sorter(e){const t=e.target.value;this.sortcriteria=t,this.tunelist.sort((a,r)=>{const i=this.sortcriteria=="type"?a.tuneref.type:a[this.sortcriteria],c=this.sortcriteria=="type"?r.tuneref.type:r[this.sortcriteria];return i<c?this.sortorder=="ASC"?-1:1:i>c?this.sortorder=="ASC"?1:-1:0}),this.renderList()}createList(){const e=this.assignPointsTunes();this.tunelist=e.slice(0,this.numberTunes),this.renderList()}renderList(){this.contentZone.innerHTML="",this.tuneinstances=this.tunelist.map(e=>new Dt("tune"+e.id,this.contentZone,e,this.maxRehear))}}const Le=Object.freeze(Object.defineProperty({__proto__:null,Game:Tt,Learn:Mt,Login:yt,Menubar:wt,Mynotification:y,Rehear:It,Setbook:Et,Stats:Pt,Tunebook:Lt,Tunemanager:Ne,Videos:jt},Symbol.toStringTag,{value:"Module"}));function Ot(n){return n&&n.__esModule&&Object.prototype.hasOwnProperty.call(n,"default")?n.default:n}var Ae=Object.prototype.toString,He=function(s){var e=Ae.call(s),t=e==="[object Arguments]";return t||(t=e!=="[object Array]"&&s!==null&&typeof s=="object"&&typeof s.length=="number"&&s.length>=0&&Ae.call(s.callee)==="[object Function]"),t},ce,_e;function Ct(){if(_e)return ce;_e=1;var n;if(!Object.keys){var s=Object.prototype.hasOwnProperty,e=Object.prototype.toString,t=He,a=Object.prototype.propertyIsEnumerable,r=!a.call({toString:null},"toString"),i=a.call(function(){},"prototype"),c=["toString","toLocaleString","valueOf","hasOwnProperty","isPrototypeOf","propertyIsEnumerable","constructor"],d=function(g){var m=g.constructor;return m&&m.prototype===g},f={$applicationCache:!0,$console:!0,$external:!0,$frame:!0,$frameElement:!0,$frames:!0,$innerHeight:!0,$innerWidth:!0,$onmozfullscreenchange:!0,$onmozfullscreenerror:!0,$outerHeight:!0,$outerWidth:!0,$pageXOffset:!0,$pageYOffset:!0,$parent:!0,$scrollLeft:!0,$scrollTop:!0,$scrollX:!0,$scrollY:!0,$self:!0,$webkitIndexedDB:!0,$webkitStorageInfo:!0,$window:!0},$=function(){if(typeof window>"u")return!1;for(var g in window)try{if(!f["$"+g]&&s.call(window,g)&&window[g]!==null&&typeof window[g]=="object")try{d(window[g])}catch{return!0}}catch{return!0}return!1}(),A=function(g){if(typeof window>"u"||!$)return d(g);try{return d(g)}catch{return!1}};n=function(m){var E=m!==null&&typeof m=="object",T=e.call(m)==="[object Function]",I=t(m),j=E&&e.call(m)==="[object String]",U=[];if(!E&&!T&&!I)throw new TypeError("Object.keys called on a non-object");var pt=i&&T;if(j&&m.length>0&&!s.call(m,0))for(var ne=0;ne<m.length;++ne)U.push(String(ne));if(I&&m.length>0)for(var ie=0;ie<m.length;++ie)U.push(String(ie));else for(var oe in m)!(pt&&oe==="prototype")&&s.call(m,oe)&&U.push(String(oe));if(r)for(var mt=A(m),H=0;H<c.length;++H)!(mt&&c[H]==="constructor")&&s.call(m,c[H])&&U.push(c[H]);return U}}return ce=n,ce}var Rt=Array.prototype.slice,Bt=He,Ee=Object.keys,Q=Ee?function(s){return Ee(s)}:Ct(),Te=Object.keys;Q.shim=function(){if(Object.keys){var s=function(){var e=Object.keys(arguments);return e&&e.length===arguments.length}(1,2);s||(Object.keys=function(t){return Bt(t)?Te(Rt.call(t)):Te(t)})}else Object.keys=Q;return Object.keys||Q};var Ft=Q,Nt=Error,zt=EvalError,Ut=RangeError,Ht=ReferenceError,Ge=SyntaxError,W=TypeError,Gt=URIError,Vt=function(){if(typeof Symbol!="function"||typeof Object.getOwnPropertySymbols!="function")return!1;if(typeof Symbol.iterator=="symbol")return!0;var s={},e=Symbol("test"),t=Object(e);if(typeof e=="string"||Object.prototype.toString.call(e)!=="[object Symbol]"||Object.prototype.toString.call(t)!=="[object Symbol]")return!1;var a=42;s[e]=a;for(e in s)return!1;if(typeof Object.keys=="function"&&Object.keys(s).length!==0||typeof Object.getOwnPropertyNames=="function"&&Object.getOwnPropertyNames(s).length!==0)return!1;var r=Object.getOwnPropertySymbols(s);if(r.length!==1||r[0]!==e||!Object.prototype.propertyIsEnumerable.call(s,e))return!1;if(typeof Object.getOwnPropertyDescriptor=="function"){var i=Object.getOwnPropertyDescriptor(s,e);if(i.value!==a||i.enumerable!==!0)return!1}return!0},qe=typeof Symbol<"u"&&Symbol,Wt=Vt,Kt=function(){return typeof qe!="function"||typeof Symbol!="function"||typeof qe("foo")!="symbol"||typeof Symbol("bar")!="symbol"?!1:Wt()},de={__proto__:null,foo:{}},Jt=Object,Zt=function(){return{__proto__:de}.foo===de.foo&&!(de instanceof Jt)},Yt="Function.prototype.bind called on incompatible ",Qt=Object.prototype.toString,Xt=Math.max,es="[object Function]",je=function(s,e){for(var t=[],a=0;a<s.length;a+=1)t[a]=s[a];for(var r=0;r<e.length;r+=1)t[r+s.length]=e[r];return t},ts=function(s,e){for(var t=[],a=e,r=0;a<s.length;a+=1,r+=1)t[r]=s[a];return t},ss=function(n,s){for(var e="",t=0;t<n.length;t+=1)e+=n[t],t+1<n.length&&(e+=s);return e},as=function(s){var e=this;if(typeof e!="function"||Qt.apply(e)!==es)throw new TypeError(Yt+e);for(var t=ts(arguments,1),a,r=function(){if(this instanceof a){var $=e.apply(this,je(t,arguments));return Object($)===$?$:this}return e.apply(s,je(t,arguments))},i=Xt(0,e.length-t.length),c=[],d=0;d<i;d++)c[d]="$"+d;if(a=Function("binder","return function ("+ss(c,",")+"){ return binder.apply(this,arguments); }")(r),e.prototype){var f=function(){};f.prototype=e.prototype,a.prototype=new f,f.prototype=null}return a},rs=as,ge=Function.prototype.bind||rs,ns=Function.prototype.call,is=Object.prototype.hasOwnProperty,os=ge,Ve=os.call(ns,is),p,ls=Nt,cs=zt,ds=Ut,us=Ht,z=Ge,N=W,hs=Gt,We=Function,ue=function(n){try{return We('"use strict"; return ('+n+").constructor;")()}catch{}},O=Object.getOwnPropertyDescriptor;if(O)try{O({},"")}catch{O=null}var he=function(){throw new N},ps=O?function(){try{return arguments.callee,he}catch{try{return O(arguments,"callee").get}catch{return he}}}():he,R=Kt(),ms=Zt(),_=Object.getPrototypeOf||(ms?function(n){return n.__proto__}:null),F={},fs=typeof Uint8Array>"u"||!_?p:_(Uint8Array),C={__proto__:null,"%AggregateError%":typeof AggregateError>"u"?p:AggregateError,"%Array%":Array,"%ArrayBuffer%":typeof ArrayBuffer>"u"?p:ArrayBuffer,"%ArrayIteratorPrototype%":R&&_?_([][Symbol.iterator]()):p,"%AsyncFromSyncIteratorPrototype%":p,"%AsyncFunction%":F,"%AsyncGenerator%":F,"%AsyncGeneratorFunction%":F,"%AsyncIteratorPrototype%":F,"%Atomics%":typeof Atomics>"u"?p:Atomics,"%BigInt%":typeof BigInt>"u"?p:BigInt,"%BigInt64Array%":typeof BigInt64Array>"u"?p:BigInt64Array,"%BigUint64Array%":typeof BigUint64Array>"u"?p:BigUint64Array,"%Boolean%":Boolean,"%DataView%":typeof DataView>"u"?p:DataView,"%Date%":Date,"%decodeURI%":decodeURI,"%decodeURIComponent%":decodeURIComponent,"%encodeURI%":encodeURI,"%encodeURIComponent%":encodeURIComponent,"%Error%":ls,"%eval%":eval,"%EvalError%":cs,"%Float32Array%":typeof Float32Array>"u"?p:Float32Array,"%Float64Array%":typeof Float64Array>"u"?p:Float64Array,"%FinalizationRegistry%":typeof FinalizationRegistry>"u"?p:FinalizationRegistry,"%Function%":We,"%GeneratorFunction%":F,"%Int8Array%":typeof Int8Array>"u"?p:Int8Array,"%Int16Array%":typeof Int16Array>"u"?p:Int16Array,"%Int32Array%":typeof Int32Array>"u"?p:Int32Array,"%isFinite%":isFinite,"%isNaN%":isNaN,"%IteratorPrototype%":R&&_?_(_([][Symbol.iterator]())):p,"%JSON%":typeof JSON=="object"?JSON:p,"%Map%":typeof Map>"u"?p:Map,"%MapIteratorPrototype%":typeof Map>"u"||!R||!_?p:_(new Map()[Symbol.iterator]()),"%Math%":Math,"%Number%":Number,"%Object%":Object,"%parseFloat%":parseFloat,"%parseInt%":parseInt,"%Promise%":typeof Promise>"u"?p:Promise,"%Proxy%":typeof Proxy>"u"?p:Proxy,"%RangeError%":ds,"%ReferenceError%":us,"%Reflect%":typeof Reflect>"u"?p:Reflect,"%RegExp%":RegExp,"%Set%":typeof Set>"u"?p:Set,"%SetIteratorPrototype%":typeof Set>"u"||!R||!_?p:_(new Set()[Symbol.iterator]()),"%SharedArrayBuffer%":typeof SharedArrayBuffer>"u"?p:SharedArrayBuffer,"%String%":String,"%StringIteratorPrototype%":R&&_?_(""[Symbol.iterator]()):p,"%Symbol%":R?Symbol:p,"%SyntaxError%":z,"%ThrowTypeError%":ps,"%TypedArray%":fs,"%TypeError%":N,"%Uint8Array%":typeof Uint8Array>"u"?p:Uint8Array,"%Uint8ClampedArray%":typeof Uint8ClampedArray>"u"?p:Uint8ClampedArray,"%Uint16Array%":typeof Uint16Array>"u"?p:Uint16Array,"%Uint32Array%":typeof Uint32Array>"u"?p:Uint32Array,"%URIError%":hs,"%WeakMap%":typeof WeakMap>"u"?p:WeakMap,"%WeakRef%":typeof WeakRef>"u"?p:WeakRef,"%WeakSet%":typeof WeakSet>"u"?p:WeakSet};if(_)try{null.error}catch(n){var gs=_(_(n));C["%Error.prototype%"]=gs}var ys=function n(s){var e;if(s==="%AsyncFunction%")e=ue("async function () {}");else if(s==="%GeneratorFunction%")e=ue("function* () {}");else if(s==="%AsyncGeneratorFunction%")e=ue("async function* () {}");else if(s==="%AsyncGenerator%"){var t=n("%AsyncGeneratorFunction%");t&&(e=t.prototype)}else if(s==="%AsyncIteratorPrototype%"){var a=n("%AsyncGenerator%");a&&_&&(e=_(a.prototype))}return C[s]=e,e},Pe={__proto__:null,"%ArrayBufferPrototype%":["ArrayBuffer","prototype"],"%ArrayPrototype%":["Array","prototype"],"%ArrayProto_entries%":["Array","prototype","entries"],"%ArrayProto_forEach%":["Array","prototype","forEach"],"%ArrayProto_keys%":["Array","prototype","keys"],"%ArrayProto_values%":["Array","prototype","values"],"%AsyncFunctionPrototype%":["AsyncFunction","prototype"],"%AsyncGenerator%":["AsyncGeneratorFunction","prototype"],"%AsyncGeneratorPrototype%":["AsyncGeneratorFunction","prototype","prototype"],"%BooleanPrototype%":["Boolean","prototype"],"%DataViewPrototype%":["DataView","prototype"],"%DatePrototype%":["Date","prototype"],"%ErrorPrototype%":["Error","prototype"],"%EvalErrorPrototype%":["EvalError","prototype"],"%Float32ArrayPrototype%":["Float32Array","prototype"],"%Float64ArrayPrototype%":["Float64Array","prototype"],"%FunctionPrototype%":["Function","prototype"],"%Generator%":["GeneratorFunction","prototype"],"%GeneratorPrototype%":["GeneratorFunction","prototype","prototype"],"%Int8ArrayPrototype%":["Int8Array","prototype"],"%Int16ArrayPrototype%":["Int16Array","prototype"],"%Int32ArrayPrototype%":["Int32Array","prototype"],"%JSONParse%":["JSON","parse"],"%JSONStringify%":["JSON","stringify"],"%MapPrototype%":["Map","prototype"],"%NumberPrototype%":["Number","prototype"],"%ObjectPrototype%":["Object","prototype"],"%ObjProto_toString%":["Object","prototype","toString"],"%ObjProto_valueOf%":["Object","prototype","valueOf"],"%PromisePrototype%":["Promise","prototype"],"%PromiseProto_then%":["Promise","prototype","then"],"%Promise_all%":["Promise","all"],"%Promise_reject%":["Promise","reject"],"%Promise_resolve%":["Promise","resolve"],"%RangeErrorPrototype%":["RangeError","prototype"],"%ReferenceErrorPrototype%":["ReferenceError","prototype"],"%RegExpPrototype%":["RegExp","prototype"],"%SetPrototype%":["Set","prototype"],"%SharedArrayBufferPrototype%":["SharedArrayBuffer","prototype"],"%StringPrototype%":["String","prototype"],"%SymbolPrototype%":["Symbol","prototype"],"%SyntaxErrorPrototype%":["SyntaxError","prototype"],"%TypedArrayPrototype%":["TypedArray","prototype"],"%TypeErrorPrototype%":["TypeError","prototype"],"%Uint8ArrayPrototype%":["Uint8Array","prototype"],"%Uint8ClampedArrayPrototype%":["Uint8ClampedArray","prototype"],"%Uint16ArrayPrototype%":["Uint16Array","prototype"],"%Uint32ArrayPrototype%":["Uint32Array","prototype"],"%URIErrorPrototype%":["URIError","prototype"],"%WeakMapPrototype%":["WeakMap","prototype"],"%WeakSetPrototype%":["WeakSet","prototype"]},K=ge,se=Ve,bs=K.call(Function.call,Array.prototype.concat),vs=K.call(Function.apply,Array.prototype.splice),Ie=K.call(Function.call,String.prototype.replace),ae=K.call(Function.call,String.prototype.slice),xs=K.call(Function.call,RegExp.prototype.exec),ws=/[^%.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(?:\.|\[\])(?:\.|\[\]|%$))/g,$s=/\\(\\)?/g,Ss=function(s){var e=ae(s,0,1),t=ae(s,-1);if(e==="%"&&t!=="%")throw new z("invalid intrinsic syntax, expected closing `%`");if(t==="%"&&e!=="%")throw new z("invalid intrinsic syntax, expected opening `%`");var a=[];return Ie(s,ws,function(r,i,c,d){a[a.length]=c?Ie(d,$s,"$1"):i||r}),a},ks=function(s,e){var t=s,a;if(se(Pe,t)&&(a=Pe[t],t="%"+a[0]+"%"),se(C,t)){var r=C[t];if(r===F&&(r=ys(t)),typeof r>"u"&&!e)throw new N("intrinsic "+s+" exists, but is not available. Please file an issue!");return{alias:a,name:t,value:r}}throw new z("intrinsic "+s+" does not exist!")},J=function(s,e){if(typeof s!="string"||s.length===0)throw new N("intrinsic name must be a non-empty string");if(arguments.length>1&&typeof e!="boolean")throw new N('"allowMissing" argument must be a boolean');if(xs(/^%?[^%]*%?$/,s)===null)throw new z("`%` may not be present anywhere but at the beginning and end of the intrinsic name");var t=Ss(s),a=t.length>0?t[0]:"",r=ks("%"+a+"%",e),i=r.name,c=r.value,d=!1,f=r.alias;f&&(a=f[0],vs(t,bs([0,1],f)));for(var $=1,A=!0;$<t.length;$+=1){var g=t[$],m=ae(g,0,1),E=ae(g,-1);if((m==='"'||m==="'"||m==="`"||E==='"'||E==="'"||E==="`")&&m!==E)throw new z("property names with quotes must have matching quotes");if((g==="constructor"||!A)&&(d=!0),a+="."+g,i="%"+a+"%",se(C,i))c=C[i];else if(c!=null){if(!(g in c)){if(!e)throw new N("base intrinsic for "+s+" exists, but the property is not available.");return}if(O&&$+1>=t.length){var T=O(c,g);A=!!T,A&&"get"in T&&!("originalValue"in T.get)?c=T.get:c=c[g]}else A=se(c,g),c=c[g];A&&!d&&(C[i]=c)}}return c},Ls=J,X=Ls("%Object.defineProperty%",!0)||!1;if(X)try{X({},"a",{value:1})}catch{X=!1}var ye=X,As=J,ee=As("%Object.getOwnPropertyDescriptor%",!0);if(ee)try{ee([],"length")}catch{ee=null}var Ke=ee,De=ye,_s=Ge,B=W,Me=Ke,Je=function(s,e,t){if(!s||typeof s!="object"&&typeof s!="function")throw new B("`obj` must be an object or a function`");if(typeof e!="string"&&typeof e!="symbol")throw new B("`property` must be a string or a symbol`");if(arguments.length>3&&typeof arguments[3]!="boolean"&&arguments[3]!==null)throw new B("`nonEnumerable`, if provided, must be a boolean or null");if(arguments.length>4&&typeof arguments[4]!="boolean"&&arguments[4]!==null)throw new B("`nonWritable`, if provided, must be a boolean or null");if(arguments.length>5&&typeof arguments[5]!="boolean"&&arguments[5]!==null)throw new B("`nonConfigurable`, if provided, must be a boolean or null");if(arguments.length>6&&typeof arguments[6]!="boolean")throw new B("`loose`, if provided, must be a boolean");var a=arguments.length>3?arguments[3]:null,r=arguments.length>4?arguments[4]:null,i=arguments.length>5?arguments[5]:null,c=arguments.length>6?arguments[6]:!1,d=!!Me&&Me(s,e);if(De)De(s,e,{configurable:i===null&&d?d.configurable:!i,enumerable:a===null&&d?d.enumerable:!a,value:t,writable:r===null&&d?d.writable:!r});else if(c||!a&&!r&&!i)s[e]=t;else throw new _s("This environment does not support defining a property as non-configurable, non-writable, or non-enumerable.")},me=ye,Ze=function(){return!!me};Ze.hasArrayLengthDefineBug=function(){if(!me)return null;try{return me([],"length",{value:1}).length!==1}catch{return!0}};var Ye=Ze,Es=Ft,Ts=typeof Symbol=="function"&&typeof Symbol("foo")=="symbol",qs=Object.prototype.toString,js=Array.prototype.concat,Oe=Je,Ps=function(n){return typeof n=="function"&&qs.call(n)==="[object Function]"},Qe=Ye(),Is=function(n,s,e,t){if(s in n){if(t===!0){if(n[s]===e)return}else if(!Ps(t)||!t())return}Qe?Oe(n,s,e,!0):Oe(n,s,e)},Xe=function(n,s){var e=arguments.length>2?arguments[2]:{},t=Es(s);Ts&&(t=js.call(t,Object.getOwnPropertySymbols(s)));for(var a=0;a<t.length;a+=1)Is(n,t[a],s[t[a]],e[t[a]])};Xe.supportsDescriptors=!!Qe;var et=Xe,tt={exports:{}},Ds=J,Ce=Je,Ms=Ye(),Re=Ke,Be=W,Os=Ds("%Math.floor%"),Cs=function(s,e){if(typeof s!="function")throw new Be("`fn` is not a function");if(typeof e!="number"||e<0||e>4294967295||Os(e)!==e)throw new Be("`length` must be a positive 32-bit integer");var t=arguments.length>2&&!!arguments[2],a=!0,r=!0;if("length"in s&&Re){var i=Re(s,"length");i&&!i.configurable&&(a=!1),i&&!i.writable&&(r=!1)}return(a||r||!t)&&(Ms?Ce(s,"length",e,!0,!0):Ce(s,"length",e)),s};(function(n){var s=ge,e=J,t=Cs,a=W,r=e("%Function.prototype.apply%"),i=e("%Function.prototype.call%"),c=e("%Reflect.apply%",!0)||s.call(i,r),d=ye,f=e("%Math.max%");n.exports=function(g){if(typeof g!="function")throw new a("a function is required");var m=c(s,i,arguments);return t(m,1+f(0,g.length-(arguments.length-1)),!0)};var $=function(){return c(s,r,arguments)};d?d(n.exports,"apply",{value:$}):n.exports.apply=$})(tt);var st=tt.exports,Rs=W,Bs=function(s){if(s==null)throw new Rs(arguments.length>0&&arguments[1]||"Cannot call method on "+s);return s},at=J,rt=st,Fs=rt(at("String.prototype.indexOf")),Ns=function(s,e){var t=at(s,!!e);return typeof t=="function"&&Fs(s,".prototype.")>-1?rt(t):t},zs=Bs,nt=Ns,Us=nt("Object.prototype.propertyIsEnumerable"),Hs=nt("Array.prototype.push"),it=function(s){var e=zs(s),t=[];for(var a in e)Us(e,a)&&Hs(t,[a,e[a]]);return t},Gs=it,ot=function(){return typeof Object.entries=="function"?Object.entries:Gs},Vs=ot,Ws=et,Ks=function(){var s=Vs();return Ws(Object,{entries:s},{entries:function(){return Object.entries!==s}}),s},Js=et,Zs=st,Ys=it,lt=ot,Qs=Ks,ct=Zs(lt(),Object);Js(ct,{getPolyfill:lt,implementation:Ys,shim:Qs});var Xs=ct,be=Xs,dt=Ve,ea=function(s){},fe=String.prototype.replace,ut=String.prototype.split,te="||||",Y=function(n){var s=n%100,e=s%10;return s!==11&&e===1?0:2<=e&&e<=4&&!(s>=12&&s<=14)?1:2},ht={pluralTypes:{arabic:function(n){if(n<3)return n;var s=n%100;return s>=3&&s<=10?3:s>=11?4:5},bosnian_serbian:Y,chinese:function(){return 0},croatian:Y,french:function(n){return n>=2?1:0},german:function(n){return n!==1?1:0},russian:Y,lithuanian:function(n){return n%10===1&&n%100!==11?0:n%10>=2&&n%10<=9&&(n%100<11||n%100>19)?1:2},czech:function(n){return n===1?0:n>=2&&n<=4?1:2},polish:function(n){if(n===1)return 0;var s=n%10;return 2<=s&&s<=4&&(n%100<10||n%100>=20)?1:2},icelandic:function(n){return n%10!==1||n%100===11?1:0},slovenian:function(n){var s=n%100;return s===1?0:s===2?1:s===3||s===4?2:3},romanian:function(n){if(n===1)return 0;var s=n%100;return n===0||s>=2&&s<=19?1:2},ukrainian:Y},pluralTypeToLanguages:{arabic:["ar"],bosnian_serbian:["bs-Latn-BA","bs-Cyrl-BA","srl-RS","sr-RS"],chinese:["id","id-ID","ja","ko","ko-KR","lo","ms","th","th-TH","zh"],croatian:["hr","hr-HR"],german:["fa","da","de","en","es","fi","el","he","hi-IN","hu","hu-HU","it","nl","no","pt","sv","tr"],french:["fr","tl","pt-br"],russian:["ru","ru-RU"],lithuanian:["lt"],czech:["cs","cs-CZ","sk"],polish:["pl"],icelandic:["is","mk"],slovenian:["sl-SL"],romanian:["ro"],ukrainian:["uk","ua"]}};function ta(n){for(var s={},e=be(n),t=0;t<e.length;t+=1)for(var a=e[t][0],r=e[t][1],i=0;i<r.length;i+=1)s[r[i]]=a;return s}function sa(n,s){var e=ta(n.pluralTypeToLanguages);return e[s]||e[ut.call(s,/-/,1)[0]]||e.en}function aa(n,s,e){return n.pluralTypes[s](e)}function ra(){var n={};return function(s,e){var t=n[e];return t&&!s.pluralTypes[t]&&(t=null,n[e]=t),t||(t=sa(s,e),t&&(n[e]=t)),t}}function Fe(n){return n.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")}function na(n){var s=n&&n.prefix||"%{",e=n&&n.suffix||"}";if(s===te||e===te)throw new RangeError('"'+te+'" token is reserved for pluralization');return new RegExp(Fe(s)+"(.*?)"+Fe(e),"g")}var ia=ra(),oa=/%\{(.*?)\}/g;function ve(n,s,e,t,a,r){if(typeof n!="string")throw new TypeError("Polyglot.transformPhrase expects argument #1 to be string");if(s==null)return n;var i=n,c=t||oa,d=r||fe,f=typeof s=="number"?{smart_count:s}:s;if(f.smart_count!=null&&n){var $=a||ht,A=ut.call(n,te),g=e||"en",m=ia($,g),E=aa($,m,f.smart_count);i=fe.call(A[E]||A[0],/^[^\S]*|[^\S]*$/g,"")}return i=d.call(i,c,function(T,I){return!dt(f,I)||f[I]==null?T:f[I]}),i}function D(n){var s=n||{};this.phrases={},this.extend(s.phrases||{}),this.currentLocale=s.locale||"en";var e=s.allowMissing?ve:null;this.onMissingKey=typeof s.onMissingKey=="function"?s.onMissingKey:e,this.warn=s.warn||ea,this.replaceImplementation=s.replace||fe,this.tokenRegex=na(s.interpolation),this.pluralRules=s.pluralRules||ht}D.prototype.locale=function(n){return n&&(this.currentLocale=n),this.currentLocale};D.prototype.extend=function(n,s){for(var e=be(n||{}),t=0;t<e.length;t+=1){var a=e[t][0],r=e[t][1],i=s?s+"."+a:a;typeof r=="object"?this.extend(r,i):this.phrases[i]=r}};D.prototype.unset=function(n,s){if(typeof n=="string")delete this.phrases[n];else for(var e=be(n||{}),t=0;t<e.length;t+=1){var a=e[t][0],r=e[t][1],i=s?s+"."+a:a;typeof r=="object"?this.unset(r,i):delete this.phrases[i]}};D.prototype.clear=function(){this.phrases={}};D.prototype.replace=function(n){this.clear(),this.extend(n)};D.prototype.t=function(n,s){var e,t,a=s??{};if(typeof this.phrases[n]=="string")e=this.phrases[n];else if(typeof a._=="string")e=a._;else if(this.onMissingKey){var r=this.onMissingKey;t=r(n,a,this.currentLocale,this.tokenRegex,this.pluralRules,this.replaceImplementation)}else this.warn('Missing translation for key: "'+n+'"'),t=n;return typeof e=="string"&&(t=ve(e,a,this.currentLocale,this.tokenRegex,this.pluralRules,this.replaceImplementation)),t};D.prototype.has=function(n){return dt(this.phrases,n)};D.transformPhrase=function(s,e,t){return ve(s,e,t)};var la=D;const ca=Ot(la),da={token:{token_ok:"Valid token, user data retrieved.",token_ko:"The saved token is not valid."},login:{title:"Log In",email:"Email",pass:"Password",login:"Login",new_user:"Do you want to create a new account?",required_mail:"Email is required",required_pass:"Enter password",login_error:"Login error"},menubar:{manager:"temas",videos:"videos",suggest:"peticiones",book:"repertorio",sets:"sets",learn:"aprender",practice:"ensayar",game:"juego",stats:"historial"}},ua={token:{token_ok:"token válido, datos de usuario recuperados.",token_ko:"el token guardado no es válido."},login:{title:"Inicio de Sesión",email:"Correo Electrónico",pass:"Contraseña",login:"Iniciar Sesión",new_user:"¿Desea crear una cuenta nueva?",required_mail:"Email obligatorio",required_pass:"Introduce contraseña",login_error:"Error en login"},menubar:{manager:"temas",videos:"videos",suggest:"peticiones",book:"repertorio",sets:"sets",learn:"aprender",practice:"ensayar",game:"juego",stats:"historial"}},k=class k{static getinstance(s){if(Object.hasOwn(Le,s)){const e=s==="Menubar"?k.menuelement:k.htmlelement,t=new Le[s](s,e);return s!=="Menubar"&&(k.activeScreen=t),t}}static async getuserdetails(){k.poly=new ca({phrases:da});const s=localStorage.getItem("token");if(s)try{const e=await L.getuser(s);l.user=e,l.user.lang!=="en"&&k.poly.replace(ua),new y("success",k.poly.t("token.token_ok")),k.startapp()}catch{new y("warning",k.poly.t("token.token_ko")),localStorage.removeItem("token"),k.getinstance("Login")}else k.getinstance("Login")}static async startapp(){await k.loadAlltunes(),k.getinstance("Menubar")}static async loadGenericPics(){if(l.genericpics=await G.initialize(),l.genericpics&&l.genericpics.length>0)return new y("success",`cargadas ${l.genericpics.length} imagenes genéricas.`),!0;new y("danger","error al cargar fotos genericas.")}static async loadAlltunes(){if(l.tunes=await L.getalltunes(),l.tunes&&l.tunes.length>0)return l.tunes.forEach(s=>{s!=null&&s.other_names?s.other_names.includes(s.main_name)||s.other_names.push(s.main_name):s.other_names=[s.main_name],(!s.sortname||s.sortname.length==0)&&(s.sortname=h.titleforsort(s.main_name))}),new y("success",`cargados ${l.tunes.length} temas.`),await k.loadUserTunebook(),!0;new y("danger","error al cargar todos los temas.")}static async loadUserTunebook(){return l.tunebook=await L.gettunebook(),l.tunebook&&l.tunebook.length>0?(l.tunebook.forEach(s=>{s.tuneref=l.tunes.find(e=>e.id===s.tunes_id),h.calcValueforTunes(s)}),new y("success",`cargados ${l.tunebook.length} temas de tu repertorio.`),await k.loadUserSetbook(),!0):(new y("info","no tienes nada en tu repertorio."),!0)}static async loadUserSetbook(){return l.setbook=await L.getsetbook(),l.setbook&&l.setbook.length>0?(new y("success",`cargados ${l.setbook.length} sets de tu repertorio.`),!0):(new y("info","no tienes ningun set."),!0)}static async addrehearsal(s){let e=l.tunebook.find(i=>i.id==s);const t=JSON.parse(JSON.stringify(e));Array.isArray(e.last_rehearsals)||(e.last_rehearsals=[]);const a=new Date;return e.last_rehearsalDate=a.valueOf(),e.last_rehearsals.unshift(e.last_rehearsalDate),e.last_rehearsals.length>10&&(e.last_rehearsals=e.last_rehearsals.slice(0,10)),e.rehearsal_days++,await L.edittunebooktune(s,e)?(h.calcValueforTunes(e),new y("success",`añadido nuevo ensayo de ${e.prefered_name}.`),!0):(e=t,new y("danger","error al guardar el ensayo."),!1)}static async changeStatus(s,e){const t=l.tunebook.find(i=>i.id==s);t.status_num=e;const a=await L.edittunebooktune(s,t),r=h.getstatus(e);return a?(new y("success",`cambiado status de ${t.prefered_name} a ${r.label}`),!0):(new y("danger","error al cambiar status."),!1)}};o(k,"htmlelement",document.getElementById("app")),o(k,"menuelement",document.getElementById("menuholder")),o(k,"activeScreen"),o(k,"midiBuffer"),o(k,"player"),o(k,"searchtunes",[]),o(k,"poly");let b=k;b.getuserdetails();
