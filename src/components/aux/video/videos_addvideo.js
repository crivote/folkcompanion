...
export class Videoadd extends Component {
  ...
  /**
   * @type {boolean} Indicator of new/edit video
   */
  isNew;
  /**
   * @type {XanoTunesLink[]} The tunes data for this video
   */
  tunes = [];
  instances;
  parent;
  ...
  /**
   * @type {Choices} Refence to instance of choices
   */
  choices;
  ...
  async setup() {
    ...
    this.tuneselector = this.element.querySelector('');
    this.choices = new Choices(this.tuneselector, {
      searchEnabled: true,
    });
    this.addListeners();
  }
  ...
  async addtunetovideo(event) {
    ...
    if (el instanceof HTMLInputElement) {
      ...
      this.instances.push(
        new Videoaddtune('tune' + newtune, this.tuneszone, {
